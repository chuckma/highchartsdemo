...
(function (K, a) {
    ...
    K = function () {
        var a = window, z = a.document, D = a.navigator && a.navigator.userAgent || "", C = z && z.createElementNS && !!z.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, B = /(edge|msie|trident)/i.test(D) && !window.opera, d = !C, h = /Firefox/.test(D), q = h && 4 > parseInt(D.split("Firefox/")[1], 10);
    ...
    (function (a) {
        var z = [], D = a.charts, C = a.doc, B = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], h = this.paths[1], q = [], t = this.now, g = a.length, p;
                if (1 === t)q = this.toD; else if (g === h.length && 1 > t)for (; g--;)p = parseFloat(a[g]), q[g] = isNaN(p) ? a[g] : t * parseFloat(h[g] - p) + p; else q = h;
                this.elem.attr("d", q, null, !0)
            }, update: function () {
                var a = this.elem, h = this.prop, q = this.now, t = this.options.step;
                if (this[h + "Setter"])this[h +
                "Setter"](); else a.attr ? a.element && a.attr(h, q, null, !0) : a.style[h] = q + this.unit;
                t && t.call(a, q, this)
            }, run: function (a, h, q) {
                var d = this, g = function (a) {
                ...
                var d = +new Date, q, t = this.options;
                q = this.elem;
                var g = t.complete, p = t.duration, f = t.curAnim, n;
                if (q.attr && !q.element)q = !1; else if (a || d >= p + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                    a = f[this.prop] = !0;
                ...
                h = h || "";
                var f, n = d.startX, w = d.endX, v = -1 < h.indexOf("C"), k = v ? 7 : 3, e, c, b;
                h = h.split(" ");
                q = q.slice();
                var F = d.isArea, u = F ? 2 : 1, r;
                v && (t(h), t(q));
                if (n && w) {
                    for (b = 0; b < n.length; b++)if (n[b] === w[0]) {
                        f = b;
                        break
        ...
        a.merge = function () {
            var d, h = arguments, q, t = {}, g = function (d, f) {
                var n, p;
                "object" !== typeof d && (d = {});
        ...
        a.attr = function (d, h, q) {
            var t, g;
            if (a.isString(h))a.defined(q) ? d.setAttribute(h, q) : d && d.getAttribute && (g = d.getAttribute(h)); else if (a.defined(h) && a.isObject(h))for (t in h)d.setAttribute(t, h[t]);
            return g
        };
        a.splat = function (d) {
        ...
        a.pick = function () {
            var a = arguments, h, q, t = a.length;
            for (h =
                     0; h < t; h++)if (q = a[h], void 0 !== q && null !== q)return q
        };
        a.css = function (d, h) {
        ...
        a.createElement = function (d, h, q, t, g) {
            ...
            var p = a.css;
            h && a.extend(d, h);
            g && p(d, {padding: 0, border: "none", margin: 0});
            q && p(d, q);
            t && t.appendChild(d);
            return d
        };
        ...
        a.wrap = function (a, h, q) {
            var d = a[h];
            a[h] = function () {
                var a = Array.prototype.slice.call(arguments), p = arguments, f = this;
                f.proceed = function () {
        ...
        a.dateFormat = function (d, h, q) {
            ...
            var t = a.Date, g = new t(h - a.getTZOffset(h)), p, f = g[t.hcGetHours](), n = g[t.hcGetDay](), w = g[t.hcGetDate](), v = g[t.hcGetMonth](), k = g[t.hcGetFullYear](), e = a.defaultOptions.lang, c = e.weekdays, b = e.shortWeekdays, F = a.pad, t = a.extend({
            ...
            for (p in t)for (; -1 !== d.indexOf("%" + p);)d = d.replace("%" + p, "function" === typeof t[p] ? t[p](h) : t[p]);
            return q ? d.substr(0, 1).toUpperCase() + d.substr(1) : d
        };
        a.formatSingle = function (d, h) {
            var q = /\.([0-9])/, t = a.defaultOptions.lang;
        ...
        a.numberFormat =
            function (d, h, q, t) {
                d = +d || 0;
                h = +h;
                var g = a.defaultOptions.lang, p = (d.toString().split(".")[1] || "").length, f, n, w = Math.abs(d);
                -1 === h ? h = Math.min(p, 20) : a.isNumber(h) || (h = 2);
        ...
        a.removeEvent = function (d, h, q) {
            ...
            function g() {
                var a, g;
                if (d.nodeName)for (g in h ? (a = {}, a[h] = !0) : a = f, a)if (f[g])for (a =
                                                                                              f[g].length; a--;)t(g, f[g][a])
            }

            var p, f = d.hcEvents, n;
        ...
        a.fireEvent = function (d, h, q, t) {
            ...
            var p, f;
            q = q || {};
            if (C.createEvent && (d.dispatchEvent || d.fireEvent))g = C.createEvent("Events"), g.initEvent(h, !0, !0), a.extend(g, q), d.dispatchEvent ? d.dispatchEvent(g) : d.fireEvent(h, g); else if (g)for (g = g[h] || [], p = g.length, q.target || a.extend(q, {
        ...
        a.animate = function (d, h, q) {
            var t, g = "", p, f, n;
            a.isObject(q) || (t = arguments, q = {duration: t[2], easing: t[3], complete: t[4]});
        ...
        a.seriesType = function (d, h, q, t, g) {
            var p = a.getOptions(), f = a.seriesTypes;
            p.plotOptions[d] = a.merge(p.plotOptions[h], q);
            f[d] = a.extendClass(f[h] || function () {
                }, t);
        ...
        C && !C.defaultView && (a.getStyle = function (d, h) {
            var q = {width: "clientWidth", height: "clientHeight"}[h];
        ...
        Array.prototype.forEach || (a.each = function (a, h, q) {
            for (var d = 0, g = a.length; d < g; d++)if (!1 === h.call(q, a[d], d, a))return d
        });
        Array.prototype.indexOf || (a.inArray = function (a, h) {
            var d, t = 0;
            if (h)for (d = h.length; t < d; t++)if (h[t] === a)return t;
            return -1
        });
        ...
        Array.prototype.find || (a.find = function (a, h) {
            var d,
                t = a.length;
            for (d = 0; d < t; d++)if (h(a[d], d))return a[d]
        })
    })(K);
    (function (a) {
        var z = a.each, D = a.isNumber, C = a.map, B = a.merge, d = a.pInt;
        a.Color = function (d) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                }); else for (g = this.parsers.length; g-- && !t;)p = this.parsers[g], (h = p.regex.exec(d)) && (t = p.parse(h));
                this.rgba = t || []
            }, get: function (a) {
                var d = this.input, h = this.rgba, g;
                this.stops ?
                ...
                if (this.stops)z(this.stops, function (g) {
                    g.brighten(a)
                }); else if (D(a) && 0 !== a)for (h = 0; 3 > h; h++)t[h] += d(255 * a), 0 > t[h] && (t[h] = 0), 255 < t[h] && (t[h] = 255);
                return this
    ...
    (function (a) {
        function z() {
            var d = a.defaultOptions.global, g, p = d.useUTC, f = p ? "getUTC" : "get", n = p ? "setUTC" : "set";
        ...
        var D = a.color, C = a.each, B = a.getTZOffset, d = a.merge, h = a.pick, q = a.win;
        a.defaultOptions = {
    ...
    (function (a) {
        var z, D, C = a.addEvent, B = a.animate, d = a.attr, h = a.charts, q = a.color, t = a.css, g = a.createElement, p = a.defined, f = a.deg2rad, n = a.destroyObjectProperties, w = a.doc,
            v = a.each, k = a.extend, e = a.erase, c = a.grep, b = a.hasTouch, F = a.isArray, u = a.isFirefox, r = a.isMS, y = a.isObject, G = a.isString, I = a.isWebKit, l = a.merge, x = a.noop, J = a.pick, L = a.pInt, N = a.removeEvent, m = a.stop, A = a.svg, P = a.SVG_NS, M = a.symbolSizes, R = a.win;
        ...
        z.prototype = {
            ...
            colorGradient: function (E, H, m) {
                var b = this.renderer, r, c, A, e, y, k, f, g, x, n, G, u = [], d;
                ...
                if (c) {
                    ...
                    f = E.stops;
                    n = m.radialReference;
                    F(A) && (E[c] = A = {x1: A[0], y1: A[1], x2: A[2], y2: A[3], gradientUnits: "userSpaceOnUse"});
                    "radialGradient" === c && n && !p(A.gradientUnits) &&
                    (e = A, A = l(A, b.getRadialAttr(n, e), {gradientUnits: "userSpaceOnUse"}));
                    ...
                    y[u] ? n = y[u].attr("id") : (A.id = n = a.uniqueKey(), y[u] = k = b.createElement(c).attr(A).add(b.defs), k.radAttr = e, k.stops = [], v(f, function (E) {
                        ...
                        E = b.createElement("stop").attr({offset: E[0], "stop-color": g, "stop-opacity": x}).add(k);
                        k.stops.push(E)
                    }));
                    d = "url(" + b.url + "#" + n + ")";
                    m.setAttribute(H,
            ...
            attr: function (a, H, b, c) {
                var E, r = this.element, A, l = this, e;
                "string" === typeof a && void 0 !== H && (E = a, a = {}, a[E] = H);
                if ("string" === typeof a)l = (this[a + "Getter"] || this._defaultGetter).call(this, a, r); else {
                    for (E in a)H =
            ...
            addClass: function (a, m) {
                ...
                -1 === E.indexOf(a) && (m || (a = (E + (E ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function (a) {
            ...
            css: function (a) {
                var m = this.styles, E = {}, b = this.element, c, l, e = "";
                c = !m;
                a && a.color && (a.fill = a.color);
                if (m)for (l in a)a[l] !== m[l] && (E[l] = a[l], c = !0);
                if (c) {
            ...
            translate: function (a, m) {
                return this.attr({translateX: a, translateY: m})
            },
            invert: function (a) {
                this.inverted = a;
            ...
            updateTransform: function () {
                var a = this.translateX || 0, m = this.translateY || 0, b = this.scaleX, c = this.scaleY, r = this.inverted, l = this.rotation, A = this.element;
            ...
            getBBox: function (a, m) {
                var b, E = this.renderer, c, H = this.element, l = this.styles, A, e = this.textStr, y, g = E.cache, x = E.cacheKeys,
                    n;
                m = J(m, this.rotation);
                c = m * f;
                A = l && l.fontSize;
            ...
            add: function (a) {
                var m = this.renderer, b = this.element, c;
            ...
            destroy: function () {
                var a = this.element || {}, b = this.renderer.isSVG &&
                    "SPAN" === a.nodeName && this.parentGroup, c, r;
            ...
            shadow: function (a, m, b) {
                var c = [], r, l, E = this.element, A, H, e, y;
            ...
            zIndexSetter: function (a, m) {
                var b = this.renderer, c = this.parentGroup, r = (c || b).element || b.box, l, A = this.element, e;
                l = this.added;
                var H;
        ...
        D.prototype = {
            Element: z, SVG_NS: P, init: function (a, m, b, c, r, l) {
                var A;
                c = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"}).css(this.getStyle(c));
                A = c.element;
                a.appendChild(A);
                -1 === a.innerHTML.indexOf("xmlns") && d(A, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = A;
                this.boxWrapper = c;
                this.alignedObjects = [];
                ...
                u && a.getBoundingClientRect && (m = function () {
                    ...
                    t(a, {left: Math.ceil(e.left) - e.left + "px", top: Math.ceil(e.top) - e.top + "px"})
                ...
                m.init(this, a);
                return m
            }, draw: x, getRadialAttr: function (a, m) {
                return {cx: a[0] - a[2] / 2 + m.cx * a[2], cy: a[1] - a[2] / 2 + m.cy * a[2], r: m.r * a[2]}
                ...
                e || p || F || u || -1 !== l.indexOf(" ") ? (k = /<.*class="([^"]+)".*>/, E = /<.*style="([^"]+)".*>/, f = /<.*href="(http[^"]+)".*>/, h && h.appendChild(m), l = e ? l.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g,
                    ...
                    v(e, function (c) {
                        if ("" !== c || 1 === e.length) {
                            var H = {}, G = w.createElementNS(b.SVG_NS, "tspan"), p, v;
                            k.test(c) && (p = c.match(k)[1], d(G, "class", p));
                            E.test(c) && (v = c.match(E)[1].replace(/(;| |^)color([ :])/,
                                "$1fill$2"), d(G, "style", v));
                            f.test(c) && !r && (d(G, "onclick", 'location.href\x3d"' + c.match(f)[1] + '"'), t(G, {cursor: "pointer"}));
                            ...
                            if (" " !== c) {
                                ...
                                d(G, H);
                                m.appendChild(G);
                                !y && l && (!A && r && t(G, {display: "block"}), d(G, "dy", M(G)));
                                if (u) {
                                    H = c.replace(/([^\^])-/g, "$1- ").split(" ");
                                    p = "nowrap" === n.whiteSpace;
                                    for (var I = 1 < e.length || l || 1 < H.length && !p, h, J, L = [], N = M(G), T = a.rotation,
                                             q = c, O = q.length; (I || F) && (H.length || L.length);)a.rotation = 0, h = a.getBBox(!0), J = h.width, !A && b.forExport && (J = b.measureSpanWidth(G.firstChild.data, a.styles)), h = J > u, void 0 === g && (g = h), F && g ? (O /= 2, "" === q || !h && .5 > O ? H = [] : (q = c.substring(0, q.length + (h ? -1 : 1) * Math.ceil(O)), H = [q + (3 < u ? "\u2026" : "")], G.removeChild(G.firstChild))) : h && 1 !== H.length ? (G.removeChild(G.firstChild), L.unshift(H.pop())) : (H = L, L = [], H.length && !p && (G = w.createElementNS(P, "tspan"), d(G, {
                                        dy: N,
                                        x: x
                ...
                var H = this.label(a, m, b, g, null, null, null, null, "button"), E = 0;
                H.attr(l({padding: 8, r: 2}, A));
                var n, x, G, u;
                A = l({
                    fill: "#f7f7f7",
                    stroke: "#cccccc",
                ...
                x = e.style;
                delete e.style;
                y = l(A, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, y);
                G = y.style;
                delete y.style;
                f = l(A, {style: {color: "#cccccc"}}, f);
                u = f.style;
                delete f.style;
                ...
                H.attr(A).css(k({cursor: "default"}, n));
            ...
            circle: function (a, m, b) {
                ...
                a = this.symbol("arc", a || 0, m || 0, b || 0, b || 0, {innerR: c || 0, start: l || 0, end: r || 0});
                a.r = b;
                return a
            }, rect: function (a, m, b, c, l, r) {
                l = y(a) ? a.r : l;
                var A = this.createElement("rect");
                a = y(a) ? a : void 0 === a ? {} : {x: a, y: m, width: Math.max(b, 0), height: Math.max(c, 0)};
                ...
                var c = this.alignedObjects, l = c.length;
                this.width = a;
                this.height = m;
                ...
                return a ? m.attr({"class": "highcharts-" + a}) : m
            }, image: function (a, m, b, c, l) {
                var r = {preserveAspectRatio: "none"};
                1 < arguments.length && k(r, {x: m, y: b, width: c, height: l});
                ...
                var A = this, e, y = this.symbols[a], H = p(m) && y && y(Math.round(m), Math.round(b), c, l, r), f = /^url\((.*?)\)$/, n, x;
                y ? (e = this.path(H), e.attr("fill", "none"), k(e, {
                    ...
                    e[a + "Setter"] = function (a, m) {
                        var b = {}, c = this["img" + m], l = "width" === m ? "translateX" : "translateY";
                        this[m] = a;
                    ...
                    x: m,
                    y: b
                }), e.isImg = !0, p(e.imgwidth) && p(e.imgheight) ? x() : (e.attr({width: 0, height: 0}), g("img", {
                    onload: function () {
                        var a =
                            h[A.chartIndex];
                        0 === this.width && (t(this, {position: "absolute", top: "-999em"}), w.body.appendChild(this));
                        M[n] = {width: this.width, height: this.height};
                ...
                circle: function (a, m, b, c) {
                    ...
                    var A = l.end - .001;
                    c = l.innerR;
                    var e = l.open, y = Math.cos(r), k = Math.sin(r), H = Math.cos(A), A = Math.sin(A);
                    ...
                    var r = Math.min(l && l.r || 0, b, c), A = r + 6, e = l && l.anchorX;
                    l = l && l.anchorY;
                    var y;
                ...
                var r = a.uniqueKey(), e = this.createElement("clipPath").attr({id: r}).add(this.defs);
                ...
                c || (a.xSetter = function (a, m, b) {
                    var c = b.getElementsByTagName("tspan"), l, r = b.getAttribute(m), e;
                ...
                m = 24 > a ? a + 3 : Math.round(1.2 *
                    a);
                return {h: m, b: Math.round(.8 * m), f: a}
            }, rotCorr: function (a, m, b) {
                var c = a;
                m && b && (c = Math.max(c * Math.cos(m * f), 4));
                return {x: -a / 3 * Math.sin(m * f), y: c}
            }, label: function (a, m, b, c, r, e, A, y, f) {
                var n = this, x = n.g("button" !== f && "label"), g = x.text = n.text("", 0, 0, A).attr({zIndex: 1}), G, u, H = 0, d = 3, F = 0, I, h, J, M, w, L = {}, P, t, E = /^url\((.*?)\)$/.test(c), q = E, R, T, O, Q;
                ...
                O = function () {
                    var a = F + d, m;
                    m = y ? 0 : t;
                    p(I) && u && ("center" === w || "right" === w) && (a += {center: .5, right: 1}[w] * (I - u.width));
                ...
                x.onAdd = function () {
                    g.add(x);
                    x.attr({text: a || 0 === a ? a : "", x: m, y: b});
                    G && p(r) && x.attr({anchorX: r, anchorY: e})
                };
                ...
                return k(x, {
                    css: function (a) {
                        ...
                        return {width: u.width + 2 * d, height: u.height + 2 * d, x: u.x - d, y: u.y - d}
                    }, shadow: function (a) {
                        a && (T(), G && G.shadow(a));
                        return x
                    }, destroy: function () {
    ...
    (function (a) {
        var z = a.attr, D = a.createElement, C = a.css, B = a.defined, d = a.each, h = a.extend, q =
            a.isFirefox, t = a.isMS, g = a.isWebKit, p = a.pInt, f = a.SVGRenderer, n = a.win, w = a.wrap;
        h(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, k = this.element, e = this.translateX || 0, c = this.translateY || 0, b = this.x || 0, f = this.y || 0, n = this.textAlign || "left", r = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[n], y = this.styles;
                    C(k, {marginLeft: e, marginTop: c});
                    this.shadows && d(this.shadows, function (a) {
                        C(a, {marginLeft: e + 1, marginTop: c + 1})
                    });
                    this.inverted && d(k.childNodes, function (b) {
                        a.invertChild(b, k)
                    });
                    if ("SPAN" === k.tagName) {
                        var G = this.rotation, I = p(this.textWidth), l = y && y.whiteSpace, x = [G,
                            n, k.innerHTML, this.textWidth, this.textAlign].join();
                        ...
                        C(k, {left: b + (this.xCorr || 0) + "px", top: f + (this.yCorr || 0) + "px"});
                        g && (y = k.offsetHeight);
                        this.cTT = x
                    }
        ...
        h(f.prototype, {
            html: function (a, k, e) {
                var c = this.createElement("span"), b = c.element, n = c.renderer, f = n.isSVG, r = function (a, b) {
                ...
                c.attr({text: a, x: Math.round(k), y: Math.round(e)}).css({
    ...
    (function (a) {
        var z, D, C = a.createElement, B = a.css, d = a.defined, h = a.deg2rad, q = a.discardElement, t = a.doc, g = a.each, p = a.erase, f = a.extend;
        z = a.extendClass;
        var n = a.isArray, w = a.isNumber, v = a.isObject, k = a.merge;
        D = a.noop;
        var e = a.pick, c = a.pInt, b = a.SVGElement, F = a.SVGRenderer, u = a.win;
        a.svg || (D = {
            docMode8: t && 8 === t.documentMode, init: function (a, b) {
                var c = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'],
                    r = ["position: ", "absolute", ";"], l = "div" === b;
                ...
                var b = this.renderer, c = this.element, r = b.box, l = a && a.inverted, r = a ? a.element || a : r;
                a && (this.parentGroup = a);
                l && b.invertChild(c, r);
                r.appendChild(c);
                this.added = !0;
                ...
                var a = this.rotation, b = Math.cos(a * h), c = Math.sin(a * h);
                ...
                var r = k ? Math.cos(k * h) : 1, y = k ? Math.sin(k * h) : 0, n = e(this.elemHeight, this.element.offsetHeight),
                    f;
                this.xCorr = 0 > r && -a;
                this.yCorr = 0 > y && -n;
                f = 0 > r * y;
                ...
                l && "left" !== l && (this.xCorr -= a * c * (0 > r ? -1 : 1), k && (this.yCorr -= n * c * (0 > y ? -1 : 1)), B(this.element, {textAlign: l}))
                ...
                var r = [], l, y = this.element, f = this.renderer, n, g = y.style, m, A = y.path, u, d, p, G;
                ...
                if (a) {
                    ...
                    for (l = 1; 3 >= l; l++)u = 2 * p + 1 - 2 * l, k && (d = this.cutOffPath(A.value, u + .5)), m = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', u, '" filled\x3d"false" path\x3d"', d, '" coordsize\x3d"10 10" style\x3d"', y.style.cssText, '" /\x3e'], n = C(f.prepVML(m), null, {
                        left: c(g.left) +
                        e(a.offsetX, 1), top: c(g.top) + e(a.offsetY, 1)
                ...
                return this
            }, updateShadows: D, setAttr: function (a, b) {
            ...
            }, opacitySetter: D, rotationSetter: function (a, b, c) {
                c = c.style;
                this[b] = c[b] = a;
            ...
            Element: D, isIE8: -1 < u.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a, b, c) {
                var e, l;
                this.alignedObjects = [];
                ...
                var l = this.createElement(), r = v(a);
                return f(l, {
                    members: [],
                    count: 0,
                    left: (r ? a.x : a) + 1,
                    ...
                    getCSS: function (a) {
                        var b = a.element, c = b.nodeName, m = a.inverted, l = this.top - ("shape" === c ? b.offsetTop : 0), e = this.left, b = e + this.width, r = l + this.height, l = {
                            clip: "rect(" + Math.round(m ?
                                e : l) + "px," + Math.round(m ? r : b) + "px," + Math.round(m ? b : r) + "px," + Math.round(m ? l : e) + "px)"
                        };
                        !m && a.docMode8 && "DIV" === c && f(l, {width: b + "px", height: r + "px"});
                        return l
                    },
                ...
                var l = this, r, n = /^rgba/, f, y, m = "none";
                b && b.linearGradient ? y = "gradient" : b && b.radialGradient && (y = "pattern");
                if (y) {
                    var A, u, d = b.linearGradient || b.radialGradient, p, F, H, h, v, w = "";
                    b = b.stops;
                    var G, I = [], t = function () {
                    ...
                    if ("fill" === e)if ("gradient" === y)e = d.x1 || d[0] || 0, b = d.y1 || d[1] || 0, p = d.x2 || d[2] || 0, d = d.y2 || d[3] || 0, w = 'angle\x3d"' + (90 - 180 * Math.atan((d - b) / (p - e)) / Math.PI) + '"',
                        t(); else {
                        var m = d.r, q = 2 * m, B = 2 * m, z = d.cx, D = d.cy, K = c.radialReference, S, m = function () {
                ...
                return a
            }, text: F.prototype.html, path: function (a) {
                ...
                1 < arguments.length && k.attr({x: b, y: c, width: e, height: l});
                return k
            }, createElement: function (a) {
                ...
                arc: function (a, b, c, e, l) {
                    var k = l.start, r = l.end, n = l.r || c || e;
                    c = l.innerR;
                    e = Math.cos(k);
                    var f = Math.sin(k), m = Math.cos(r), A = Math.sin(r);
                    if (0 === r - k)return ["x"];
    ...
    (function (a) {
        var z = a.correctFloat, D = a.defined, C = a.destroyObjectProperties, B = a.isNumber, d = a.merge, h = a.pick, q = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, g = a.options, p = a.chart, f = a.categories, n = a.names, w = this.pos, v = g.labels, k = a.tickPositions, e = w === k[0], c = w === k[k.length - 1], n = f ? h(f[w], n[w], w) : w, f = this.label, k = k.info, b;
                a.isDatetimeAxis &&
                ...
                D(f) ? f && f.attr({text: g}) : (this.labelLength = (this.label = f = D(g) && v.enabled ? p.renderer.text(g, 0, 0, v.useHTML).css(d(v.style)).add(a.labelGroup) : null) && f.getBBox().width, this.rotation = 0)
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var g =
                    this.axis, d = a.x, f = g.chart.chartWidth, n = g.chart.spacing, w = h(g.labelLeft, Math.min(g.pos, n[3])), n = h(g.labelRight, Math.max(g.pos + g.len, f - n[1])), v = this.label, k = this.rotation, e = {
                    left: 0,
                    center: .5,
                    right: 1
                }[g.labelAlign], c = v.getBBox().width, b = g.getSlotWidth(), F = b, u = 1, r, y = {};
                if (k)0 > k && d - e * c < w ? r = Math.round(d / Math.cos(k * q) - w) : 0 < k && d + e * c > n && (r = Math.round((f - d) / Math.cos(k * q))); else if (f = d + (1 - e) * c, d - e * c < w ? F = a.x + F * (1 - e) - w : f > n && (F = n - a.x + F * e, u = -1), F = Math.min(b, F), F < b && "center" === g.labelAlign && (a.x += u * (b - F - e * (b - Math.min(c,
                ...
                var n = this.axis, p = n.chart, h = f && p.oldChartHeight || p.chartHeight;
                return {
                    ...
                    y: a ? h - n.bottom + n.offset - (n.opposite ? n.height : 0) : h - n.translate(g + d, null, null, f) - n.transB
                                           ...
                                           k) {
                var e = this.axis, c = e.transA, b = e.reversed, p = e.staggerLines, u = e.tickRotCorr || {
                        x: 0,
                        y: 0
                    }, r = n.y;
                ...
                var f = this.axis,
                    n = f.options, p = f.chart.renderer, v = f.horiz, k = this.type, e = this.label, c = this.pos, b = n.labels, F = this.gridLine, u = k ? k + "Tick" : "tick", r = f.tickSize(u), y = this.mark, G = !y, I = b.step, l = {}, x = !0, J = f.tickmarkOffset, L = this.getPosition(v, c, J, g), q = L.x, L = L.y, m = v && q === f.pos + f.len || !v && L === f.pos ? -1 : 1, A = k ? k + "Grid" : "grid", P = n[A + "LineWidth"], M = n[A + "LineColor"], t = n[A + "LineDashStyle"], A = h(n[u + "Width"], !k && f.isXAxis ? 1 : 0), u = n[u + "Color"];
                d = h(d, 1);
                this.isActive = !0;
    ...
    (function (a) {
        var z = a.arrayMax, D = a.arrayMin, C = a.defined, B = a.destroyObjectProperties, d = a.each, h = a.erase, q = a.merge, t = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var a = this, d = a.axis, f = d.horiz, n = a.options, h = n.label, v = a.label, k = n.to, e = n.from, c = n.value, b = C(e) && C(k), F = C(c), u = a.svgElem, r = !u, y = [], G, I = n.color, l = t(n.zIndex, 0), x = n.events, y = {"class": "highcharts-plot-" + (b ? "band " : "line ") + (n.className || "")}, J = {}, L = d.chart.renderer, N = b ? "bands" : "lines", m = d.log2lin;
                ...
                if (F)y = d.getPlotLinePath(c, u.strokeWidth()); else if (b)y = d.getPlotBandPath(e, k, n); else return;
                if (r && y && y.length) {
                    if (u.attr({d: y}), x)for (G in n = function (b) {
                        u.on(b, function (m) {
                            x[b].apply(a, [m])
                        })
                    }, x)n(G)
                } else u && (y ? (u.show(), u.animate({d: y})) : (u.hide(), v && (a.label = v = v.destroy())));
                ...
                f = D(n);
                h = D(d);
                g.align(a, !1, {x: f, y: h, width: z(n) - f, height: z(d) - h});
                g.show()
            }, destroy: function () {
        ...
        a.AxisPlotLineOrBandExtension = {
            getPlotBandPath: function (a, d) {
                ...
                var f = (new a.PlotLineOrBand(this, d)).render(), n = this.userOptions;
    ...
    (function (a) {
        var z = a.addEvent, D = a.animObject,
            C = a.arrayMax, B = a.arrayMin, d = a.AxisPlotLineOrBandExtension, h = a.color, q = a.correctFloat, t = a.defaultOptions, g = a.defined, p = a.deg2rad, f = a.destroyObjectProperties, n = a.each, w = a.extend, v = a.fireEvent, k = a.format, e = a.getMagnitude, c = a.grep, b = a.inArray, F = a.isArray, u = a.isNumber, r = a.isString, y = a.merge, G = a.normalizeTickInterval, I = a.pick, l = a.PlotLineOrBand, x = a.removeEvent, J = a.splat, L = a.syncTimeout, N = a.Tick;
        a.Axis = function () {
            this.init.apply(this, arguments)
        };
        a.Axis.prototype = {
            ...
            init: function (a, c) {
                ...
                -1 === b(this, a.axes) && (m ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            defaultLabelFormatter: function () {
                var b = this.axis, c = this.value, e = b.categories, l = this.dateTimeLabelFormat, d = t.lang, n = d.numericSymbols, d = d.numericSymbolMagnitude || 1E3, r = n && n.length,
                    f, u = b.options.labels.format, b = b.isLog ? c : b.tickInterval;
                if (u)f = k(u, this); else if (e)f = c; else if (l)f = a.dateFormat(l, c); else if (r && 1E3 <= b)for (; r-- && void 0 === f;)e = Math.pow(d, r + 1), b >= e && 0 === 10 * c % e && null !== n[r] && 0 !== c && (f = a.numberFormat(c / e, -1) + n[r]);
            ...
            getSeriesExtremes: function () {
                ...
                n(a.series, function (m) {
                    if (m.visible || !b.options.chart.ignoreHiddenSeries) {
                        var e = m.options, l = e.threshold, A;
                        a.hasVisibleSeries = !0;
                        a.isLog && 0 >= l && (l = null);
                        if (a.isXAxis)e = m.xData, e.length && (m = B(e), u(m) || m instanceof Date || (e = c(e, function (a) {
                            return u(a)
                        }), m = B(e)), a.dataMin = Math.min(I(a.dataMin, e[0]), m), a.dataMax = Math.max(I(a.dataMax, e[0]), C(e))); else if (m.getExtremes(), A = m.dataMax, m = m.dataMin, g(m) && g(A) && (a.dataMin = Math.min(I(a.dataMin, m), m), a.dataMax = Math.max(I(a.dataMax, A), A)), g(l) && (a.threshold = l),
                            !e.softThreshold || a.isLog)a.softThreshold = !1
                    }
                })
            },
            translate: function (a, b, c, e, l, k) {
                var m = this.linkedParent || this, A = 1, d = 0, n = e ? m.oldTransA : m.transA;
                e = e ? m.oldMin : m.min;
            ...
            getPlotLinePath: function (a, b, c, e, l) {
                var m = this.chart, A = this.left, k = this.top, d, n, r = c && m.oldChartHeight || m.chartHeight, f = c && m.oldChartWidth || m.chartWidth, g;
                d = this.transB;
            ...
            getLinearTickPositions: function (a, b, c) {
                var m, e = q(Math.floor(b / a) * a), l = q(Math.ceil(c / a) * a), A = [];
                if (b === c && u(b))return [b];
                for (b = e; b <= l;) {
                    A.push(b);
                    b = q(b + a);
            ...
            getMinorTickPositions: function () {
                var a = this.options, b = this.tickPositions, c = this.minorTickInterval, e = [], l, k = this.pointRangePadding || 0;
                l = this.min - k;
                var k = this.max + k, d = k - l;
                if (d && d / c < this.len / 3)if (this.isLog)for (k = b.length, l = 1; l < k; l++)e =
                    e.concat(this.getLogTickPositions(c, b[l - 1], b[l], !0)); else if (this.isDatetimeAxis && "auto" === a.minorTickInterval)e = e.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), l, k, a.startOfWeek)); else for (b = l + (b[0] - l) % c; b <= k && b !== e[0]; b += c)e.push(b);
                0 !== e.length && this.trimTicks(e, a.startOnTick, a.endOnTick);
                return e
            },
            adjustForMinRange: function () {
                var a = this.options, b = this.min, c = this.max, e, l = this.dataMax - this.dataMin >= this.minRange, k, d, r, f, u, x;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (g(a.min) ||
                g(a.max) ? this.minRange = null : (n(this.series, function (a) {
                    f = a.xData;
                    for (d = u = a.xIncrement ? 1 : f.length - 1; 0 < d; d--)if (r = f[d] - f[d - 1], void 0 === k || r < k)k = r
            ...
            getClosest: function () {
                ...
                this.categories ? a = 1 : n(this.series, function (b) {
                    var c = b.closestPointRange, m = b.visible || !b.chart.options.chart.ignoreHiddenSeries;
                    !b.noSharedTooltip && g(c) && m && (a = g(a) ? Math.min(a, c) : c)
                });
                return a
            },
            nameToX: function (a) {
                var c = F(this.categories), m = c ? this.categories : this.names, e = a.options.x, l;
                a.series.requireSorting = !1;
                g(e) || (e = !1 === this.options.uniqueNames ? a.series.autoIncrement() : b(a.name, m));
                -1 === e ? c || (l = m.length) : l = e;
                this.names[l] = a.name;
                return l
            },
            ...
            setAxisTranslation: function (a) {
                var b = this, c = b.max - b.min, m = b.axisPointRange || 0, e, l = 0, k = 0, d = b.linkedParent, f = !!b.categories, u = b.transA, x = b.isXAxis;
            ...
            setTickInterval: function (b) {
                var c =
                    this, m = c.chart, l = c.options, k = c.isLog, d = c.log2lin, r = c.isDatetimeAxis, f = c.isXAxis, x = c.isLinked, y = l.maxPadding, h = l.minPadding, F = l.tickInterval, p = l.tickPixelInterval, w = c.categories, J = c.threshold, L = c.softThreshold, t, N, B, z;
                ...
                r || k || F || (c.tickInterval = G(c.tickInterval, null, e(c.tickInterval), I(l.allowDecimals,
                    !(.5 < c.tickInterval && 5 > c.tickInterval && 1E3 < c.max && 9999 > c.max)), !!this.tickAmount));
                this.tickAmount || (c.tickInterval = c.unsquish());
                this.setTickPositions()
            },
            setTickPositions: function () {
                var a = this.options, b, c = a.tickPositions, e = a.tickPositioner, l = a.startOnTick, k = a.endOnTick, d;
            ...
            trimTicks: function (a, b, c) {
                var m = a[0], e = a[a.length - 1], l = this.minPointOffset || 0;
                if (b)this.min = m; else for (; this.min - l > a[0];)a.shift();
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || this.isLog || n(this.chart[this.coll], function (c) {
                    var m =
                        c.options, m = [c.horiz ? m.left : m.top, m.width, m.height, m.pane].join();
            ...
            zoom: function (a, b) {
                var c = this.dataMin, m = this.dataMax, e = this.options, l = Math.min(c, I(e.min, c)), e = Math.max(m, I(e.max, m));
                if (a !== this.min || b !== this.max)this.allowZoomOutside || (g(c) && (a < l && (a = l), a > e && (a = e)), g(m) && (b < l && (b = l), b > e && (b = e))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var a = this.chart, b = this.options, c = b.offsetLeft ||
                    0, e = this.horiz, l = I(b.width, a.plotWidth - c + (b.offsetRight || 0)), k = I(b.height, a.plotHeight), d = I(b.top, a.plotTop), b = I(b.left, a.plotLeft + c), c = /%$/;
            ...
            getThreshold: function (a) {
                var b = this.isLog, c = this.lin2log, m = b ? c(this.min) : this.min, b = b ? c(this.max) : this.max;
            ...
            tickSize: function (a) {
                var b = this.options, c = b[a + "Length"], m = I(b[a + "Width"], "tick" === a && this.isXAxis ?
                    1 : 0);
            ...
            unsquish: function () {
                var a = this.options.labels, b = this.horiz, c = this.tickInterval, e = c, l = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), k, d = a.rotation, r = this.labelMetrics(), f, x = Number.MAX_VALUE, u, y = function (a) {
                    a /= l || 1;
                    a = 1 < a ? Math.ceil(a) : 1;
                    return a * c
                };
            ...
            getSlotWidth: function () {
                var a = this.chart, b = this.horiz, c = this.options.labels, e = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), l = a.margin[3];
                return b && 2 > (c.step || 0) && !c.rotation && (this.staggerLines || 1) * a.plotWidth / e || !b && (l && l - a.spacing[3] ||
                    .33 * a.chartWidth)
            },
            renderUnsquish: function () {
                var a = this.chart, b = a.renderer, c = this.tickPositions, e = this.ticks, l = this.options.labels, k = this.horiz, d = this.getSlotWidth(), f = Math.max(1, Math.round(d - 2 * (l.padding || 5))), x = {}, u = this.labelMetrics(), g = l.style && l.style.textOverflow, h, F = 0, p, v;
                r(l.rotation) || (x.rotation = l.rotation || 0);
                n(c, function (a) {
                    (a = e[a]) && a.labelLength > F && (F = a.labelLength)
                });
                this.maxLabelLength = F;
                if (this.autoRotation)F > f && F > u.h ? x.rotation = this.labelRotation : this.labelRotation = 0; else if (d &&
                    (h = {width: f + "px"}, !g))for (h.textOverflow = "clip", p = c.length; !k && p--;)if (v = c[p], f = e[v].label)f.styles && "ellipsis" === f.styles.textOverflow ? f.css({textOverflow: "clip"}) : e[v].labelLength > d && f.css({width: d + "px"}), f.getBBox().height > this.len / c.length - (u.h - u.f) && (f.specCss = {textOverflow: "ellipsis"});
                x.rotation && (h = {width: (F > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"}, g || (h.textOverflow = "ellipsis"));
            ...
            addTitle: function (a) {
                var b = this.chart.renderer, c = this.horiz, e = this.opposite, m = this.options.title, l;
                this.axisTitle || ((l = m.textAlign) || (l = (c ? {low: "left", middle: "center", high: "right"} : {
                    low: e ? "right" : "left", middle: "center",
                    high: e ? "left" : "right"
            ...
            getOffset: function () {
                var a = this, b = a.chart, c = b.renderer, e = a.options, l = a.tickPositions, k = a.ticks, d = a.horiz, f = a.side, r = b.inverted ? [1, 0, 3, 2][f] : f, x, u, y = 0, h, F = 0, p = e.title, v = e.labels, J = 0, w = b.axisOffset, b = b.clipOffset, G = [-1, 1, 1, -1][f], L, q = e.className, t =
                    a.axisParent, B = this.tickSize("tick");
                x = a.hasData();
                a.showAxis = u = x || I(e.showEmpty, !0);
                a.staggerLines = a.horiz && v.staggerLines;
                a.axisGroup || (a.gridGroup = c.g("grid").attr({zIndex: e.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (q || "")).add(t), a.axisGroup = c.g("axis").attr({zIndex: e.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (q || "")).add(t), a.labelGroup = c.g("axis-labels").attr({zIndex: v.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (q ||
                    "")).add(t));
                ...
                }), a.staggerLines && (J *= a.staggerLines, a.labelOffset = J * (a.opposite ? -1 : 1)); else for (L in k)k[L].destroy(), delete k[L];
            ...
            getLinePath: function (a) {
                var b = this.chart, c = this.opposite, e = this.offset, l = this.horiz, m = this.left + (c ? this.width : 0) + e, e = b.chartHeight - this.bottom -
                    (c ? this.height : 0) + e;
                c && (a *= -1);
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, c = this.top, e = this.len, l = this.options.title, k = a ? b : c, d =
                    this.opposite, f = this.offset, r = l.x || 0, n = l.y || 0, x = this.chart.renderer.fontMetrics(l.style && l.style.fontSize, this.axisTitle).f, e = {
                    low: k + (a ? 0 : e),
                    middle: k + e / 2,
                    high: k + (a ? e : 0)
                }[l.align], b = (a ? c + this.height : b) + (a ? 1 : -1) * (d ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? x : 0);
                return {
            ...
            render: function () {
                var a = this, b = a.chart, c = b.renderer, e = a.options, k = a.isLog, d = a.lin2log, f = a.isLinked, r = a.tickPositions, x = a.axisTitle, g = a.ticks, y = a.minorTicks, h = a.alternateBands,
                    F = e.stackLabels, p = e.alternateGridColor, v = a.tickmarkOffset, J = a.axisLine, w = b.hasRendered && u(a.oldMin), G = a.showAxis, I = D(c.globalAnimation), q, t;
                ...
                J && (J[J.isPlaced ? "animate" : "attr"]({d: this.getLinePath(J.strokeWidth())}), J.isPlaced = !0, J[G ? "show" : "hide"](!0));
            ...
            destroy: function (a) {
                var c = this, e = c.stacks, l, m = c.plotLinesAndBands, k;
                a || x(c);
            ...
            drawCrosshair: function (a, b) {
                var c, e = this.crosshair, l = I(e.snap, !0), m, k = this.cross;
                ...
                this.crosshair && !1 !== (g(b) || !l) ? (l ? g(b) && (m = this.isXAxis ? b.plotX : this.len - b.plotY) : m = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), g(m) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : I(b.stackY, b.y)), null, null, null, m) || null), g(c) ? (b = this.categories && !this.isRadial, k || (this.cross = k = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " :
                        "thin ") + e.className).attr({zIndex: I(e.zIndex, 2)}).add(), k.attr({
                    stroke: e.color || (b ? h("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
                    "stroke-width": I(e.width, 1)
                }), e.dashStyle && k.attr({dashstyle: e.dashStyle})), k.show().attr({d: c}), b && !e.width && k.attr({"stroke-width": this.transA}), this.cross.e = a) : this.hideCrosshair()) : this.hideCrosshair()
            },
    ...
    (function (a) {
        var z = a.Axis, D = a.getMagnitude, C = a.map, B = a.normalizeTickInterval, d = a.pick;
        z.prototype.getLogTickPositions = function (a, q, t, g) {
            var h = this.options, f = this.len, n = this.lin2log, w = this.log2lin, v = [];
            g || (this._minorAutoInterval = null);
            if (.5 <= a)a = Math.round(a), v = this.getLinearTickPositions(a, q, t); else if (.08 <= a)for (var f = Math.floor(q), k, e, c, b, F, h = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < t + 1 && !F; f++)for (e = h.length, k = 0; k < e && !F; k++)c = w(n(f) * h[k]), c > q && (!g || b <= t) && void 0 !== b && v.push(b), b > t && (F = !0), b = c; else q = n(q), t = n(t), a = h[g ? "minorTickInterval" : "tickInterval"], a = d("auto" ===
    ...
    (function (a) {
        var z = a.dateFormat, D = a.each, C = a.extend, B = a.format, d = a.isNumber, h = a.map, q = a.merge, t = a.pick, g = a.splat, p = a.syncTimeout, f = a.timeUnits;
        a.Tooltip =
            function () {
                this.init.apply(this, arguments)
            };
        a.Tooltip.prototype = {
            ...
            move: function (a, d, f, k) {
                var e = this, c = e.now, b = !1 !== e.options.animation && !e.isHidden && (1 < Math.abs(a - c.x) || 1 < Math.abs(d - c.y)), n = e.followPointer || 1 < e.len;
                C(c, {
                    x: b ? (2 * c.x + a) / 3 : a,
                    y: b ? (c.y + d) / 2 : d,
                ...
                var f, k = this.chart, e = k.inverted, c = k.plotTop, b = k.plotLeft, n = 0, u = 0, r, y;
                a = g(a);
                f = a[0].tooltipPos;
                ...
                }), n /= a.length, u /= a.length, f = [e ? k.plotWidth - u : n, this.shared && !e && 1 < a.length && d ? d.chartY - c : e ? k.plotHeight - n : u]);
                return h(f, Math.round)
            }, getPosition: function (a, d, f) {
                var k = this.chart, e = this.distance, c = {}, b = f.h || 0, n, u = ["y", k.chartHeight, d, f.plotY + k.plotTop, k.plotTop, k.plotTop + k.plotHeight], r = ["x", k.chartWidth, a, f.plotX + k.plotLeft, k.plotLeft, k.plotLeft + k.plotWidth], g = !this.followPointer && t(f.ttBelow, !k.inverted === !!f.negative), h = function (a, l, d, m, k, f) {
                    var r = d < m - e, n = m + e + d < l, x = m - e - d;
                    m += e;
                    if (g && n)c[a] = m; else if (!g && r)c[a] = x; else if (r)c[a] = Math.min(f - d, 0 > x - b ? x : x - b);
                    else if (n)c[a] = Math.max(k, m + b + d > l ? m : m + b); else return !1
                }, p = function (a, b, l, m) {
                    var d;
                ...
                return f
                                  ...
                                  d) {
                var f = this.chart, k, e = this.options, c, b, n = {}, u = [];
                k = e.formatter || this.defaultFormatter;
                var n = f.hoverPoints, r = this.shared;
                clearTimeout(this.hideTimer);
                ...
                }), n = {x: a[0].category, y: a[0].y}, n.points = u, this.len = u.length, a = a[0]);
                n = k.call(n,
                    this);
                r = a.series;
                this.distance = t(r.tooltipOptions.distance, 16);
                !1 === n ? this.hide() : (k = this.getLabel(), this.isHidden && k.attr({opacity: 1}).show(), this.split ? this.renderSplit(n, f.hoverPoints) : (k.attr({text: n && n.join ? n.join("") : n}), k.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + t(a.colorIndex, r.colorIndex)), k.attr({stroke: e.borderColor || a.color || r.color || "#666666"}), this.updatePosition({
                    plotX: d,
                    plotY: c,
                    negative: a.negative,
                    ttBelow: a.ttBelow,
                    h: b[2] || 0
                                      ...
                                      f) {
                var n = this, k = [], e = this.chart, c = e.renderer, b = !0, g = this.options, u, r = this.getLabel();
                D(d.slice(0, d.length - 1), function (a, d) {
                    d = f[d - 1] || {isHeader: !0, plotX: f[0].plotX};
                    var y = d.series || n, l = y.tt, x = d.series || {}, h = "highcharts-color-" + t(d.colorIndex, x.colorIndex, "none");
                ...
                var d = this.chart, f = this.getLabel(), f = (this.options.positioner || this.getPosition).call(this, f.width, f.height, a);
                this.move(Math.round(f.x), Math.round(f.y || 0), a.plotX + d.plotLeft, a.plotY + d.plotTop)
            }, getXDateFormat: function (a, d, g) {
                var k;
                d = d.dateTimeLabelFormats;
                var e = g && g.closestPointRange, c, b = {
                    millisecond: 15,
                    second: 12,
                    minute: 9,
                    hour: 6,
                ...
                f = a.series;
                var k = f.tooltipOptions, e = k.xDateFormat,
                    c = f.xAxis, b = c && "datetime" === c.options.type && d(a.key), n = k[n + "Format"];
                b && !e && (e = this.getXDateFormat(a, k, c));
                b && e && (n = n.replace("{point.key}", "{point.key:" + e + "}"));
                return B(n, {point: a, series: f})
    ...
    (function (a) {
        var z = a.addEvent, D = a.attr, C = a.charts, B = a.color, d = a.css, h = a.defined, q = a.doc, t = a.each, g = a.extend, p = a.fireEvent, f = a.offset, n = a.pick,
            w = a.removeEvent, v = a.splat, k = a.Tooltip, e = a.win;
        ...
        a.Pointer.prototype = {
            init: function (a, b) {
                ...
                var b = this.chart, e = b.series, d = b.tooltip, k = d ? d.shared : !1, f = !0, g = b.hoverPoint, h = b.hoverSeries, l, x, p, v = [], w;
                if (!k && !h)for (l = 0; l < e.length; l++)if (e[l].directTouch || !e[l].options.stickyTracking)e = [];
                h && (k ? h.noSharedTooltip : h.directTouch) && g ? v = [g] : (k || !h || h.options.stickyTracking || (e = [h]), t(e, function (a) {
                    ...
                    var c = a.distX - b.distX, e = a.dist - b.dist, l = b.series.group.zIndex - a.series.group.zIndex;
                    return 0 !== c && k ? c : 0 !== e ? e : 0 !== l ? l : a.series.index > b.series.index ? -1 : 1
                }));
                if (k)for (l = v.length; l--;)(v[l].x !== v[0].x || v[l].series.noSharedTooltip) && v.splice(l, 1);
                ...
                var c = this.chart, e = c.hoverSeries, d = c.hoverPoint, k = c.hoverPoints, f = c.tooltip, n = f && f.shared ? k : d;
                ...
                var b = this.chart, c = b.options.chart, e = a.chartX, d = a.chartY, k = this.zoomHor, f = this.zoomVert, n = b.plotLeft, l = b.plotTop, x = b.plotWidth, g = b.plotHeight, h, p = this.selectionMarker, m = this.mouseDownX, v = this.mouseDownY, q = c.panKey && a[c.panKey + "Key"];
                ...
                if (this.selectionMarker) {
                    var k =
                    {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, f = this.selectionMarker, n = f.attr ? f.attr("x") : f.x, v = f.attr ? f.attr("y") : f.y, l = f.attr ? f.attr("width") : f.width, x = f.attr ? f.attr("height") : f.height, J;
                    if (this.hasDragged || e)t(c.axes, function (c) {
                        if (c.zoomEnabled && h(c.min) && (e || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var d = c.horiz, m = "touchend" === a.type ? c.minPixelPadding : 0, f = c.toValue((d ? n : v) + m), d = c.toValue((d ? n + l : v + x) - m);
                            k[c.coll].push({axis: c, min: Math.min(f, d), max: Math.max(f, d)});
                            J = !0
                        }
                ...
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (p(c.series, "click", g(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (g(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - e, a.chartY - d) && p(b, "click", a)))
    ...
    (function (a) {
        var z = a.charts, D = a.each, C = a.extend, B = a.map, d = a.noop, h = a.pick;
        C(a.Pointer.prototype, {
            pinchTranslate: function (a, d, g, h, f, n) {
                ...
                var k = this.chart, e = a ? "x" : "y", c = a ? "X" : "Y", b = "chart" +
                    c, p = a ? "width" : "height", u = k["plot" + (a ? "Left" : "Top")], r, y, q = v || 1, I = k.inverted, l = k.bounds[a ? "h" : "v"], x = 1 === d.length, J = d[0][b], L = g[0][b], t = !x && d[1][b], m = !x && g[1][b], A;
                g = function () {
                ...
                var q = this, g = q.chart, p = q.pinchDown, f = a.touches, n = f.length, w = q.lastValidTouch, v = q.hasZoom, k = q.selectionMarker, e = {}, c = 1 === n && (q.inClass(a.target, "highcharts-tracker") && g.runTrackerClick || q.runChartClick), b = {};
                1 < n && (q.initiated = !0);
                ...
                "touchstart" === a.type ? (D(f, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b =
                            g.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding, e = a.toPixels(h(a.options.min, a.dataMin)), d = a.toPixels(h(a.options.max, a.dataMax)), k = Math.max(e, d);
                ...
                var g = this.chart, p, f;
                if (g.index !== a.hoverChartIndex)this.onContainerMouseLeave({relatedTarget: !0});
    ...
    (function (a) {
        var z = a.addEvent, D = a.charts, C = a.css, B = a.doc, d = a.extend, h = a.noop, q = a.Pointer, t = a.removeEvent, g = a.win, p = a.wrap;
        if (g.PointerEvent || g.MSPointerEvent) {
            var f = {}, n = !!g.PointerEvent, w = function () {
                var a, e = [];
                e.item = function (a) {
                    return this[a]
                };
                for (a in f)f.hasOwnProperty(a) && e.push({pageX: f[a].pageX, pageY: f[a].pageY, target: f[a].target});
                return e
            }, v = function (d, e, c, b) {
            ...
            p(q.prototype, "init", function (a, e, c) {
                a.call(this, e, c);
                this.hasZoom &&
                C(e.container, {"-ms-touch-action": "none", "touch-action": "none"})
            });
    ...
    (function (a) {
        var z, D = a.addEvent, C = a.css, B = a.discardElement, d = a.defined, h = a.each, q = a.extend, t = a.isFirefox, g = a.marginNames, p = a.merge, f = a.pick, n = a.setAnimation, w = a.stableSort, v = a.win, k = a.wrap;
        ...
        z.prototype =
        {
            ...
            var b = this.options, e = a.legendItem, d = a.legendLine, f = a.legendSymbol, k = this.itemHiddenStyle.color, b = c ? b.itemStyle.color : k, n = c ? a.color || k : k, g = a.options && a.options.marker, l = {fill: n}, x;
            e && e.css({fill: b, color: b});
            d && d.attr({stroke: n});
            if (f) {
                if (g && f.isMarker && (l = a.pointAttribs(), !c))for (x in l)l[x] =
                    k;
                f.attr(l)
            }
        }, positionItem: function (a) {
            var c = this.options, b = c.symbolPadding, c = !c.rtl, e = a._legendItemPos, d = e[0], e = e[1], f = a.checkbox;
            ...
            var c = this.group && this.group.alignAttr, b, e = this.clipHeight || this.legendHeight, d = this.titleHeight;
            ...
            c.text && (this.title || (this.title = this.chart.renderer.label(c.text,
                a - 3, a - 4, null, null, null, null, null, "legend-title").attr({zIndex: 1}).css(c.style).add(this.group)), a = this.title.getBBox(), b = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: b}));
            this.titleHeight = b
        }, setText: function (e) {
            var c = this.options;
            e.legendItem.attr({text: c.labelFormat ? a.format(c.labelFormat, e) : c.labelFormatter.call(e)})
        }, renderItem: function (a) {
            var c = this.chart, b = c.renderer, e = this.options, d = "horizontal" === e.layout, k = this.symbolWidth, n = e.symbolPadding, g = this.itemStyle, h = this.itemHiddenStyle,
                l = this.padding, x = d ? f(e.itemDistance, 20) : 0, v = !e.rtl, q = e.width, w = e.itemMarginBottom || 0, m = this.itemMarginTop, A = this.initialItemX, t = a.legendItem, M = !a.series, B = !M && a.series.drawLegendSymbol ? a.series : a, E = B.options, E = this.createCheckboxForItem && E && E.showCheckbox, H = e.useHTML;
            t || (a.legendGroup = b.g("legend-item").addClass("highcharts-" + B.type + "-series highcharts-color-" + a.colorIndex + (a.options.className ? " " + a.options.className : "") + (M ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup),
            ...
            var b = this.chart, e = this.options, k = e.align.charAt(0) + e.verticalAlign.charAt(0) + e.layout.charAt(0);
            ...
            var a = this, c = a.chart, b = c.renderer, d = a.group, k, f, n, g, p = a.box, l = a.options, x = a.padding;
            ...
            f && d.align(q({width: n, height: g}, l), !0, "spacingBox");
            c.isResizing || this.positionCheckboxes()
        }, handleOverflow: function (a) {
            var c = this, b = this.chart, e = b.renderer, d = this.options, k = d.y, b = b.spacingBox.height + ("top" === d.verticalAlign ? -k : k) - this.padding, k = d.maxHeight, n, g = this.clipRect, p = d.navigation, l = f(p.animation, !0), x = p.arrowSize || 12, v = this.nav, q = this.pages, w = this.padding, m, t = this.allItems, B = function (a) {
                a ?
                    g.attr({height: a}) : g && (c.clipRect = g.destroy(), c.contentGroup.clip());
            ...
            a > b && !1 !== p.enabled ? (this.clipHeight = n = Math.max(b - 20 - this.titleHeight - w, 0), this.currentPage = f(this.currentPage, 1), this.fullHeight = a, h(t, function (a, b) {
                ...
                c !== m && (m = c)
            }), g || (g = c.clipRect = e.clipRect(0, w, 9999, 0), c.contentGroup.clip(g)), B(n), v || (this.nav = v = e.g().attr({zIndex: 1}).add(this.group), this.up = e.symbol("triangle", 0, 0, x, x).on("click", function () {
                c.scroll(-1, l)
                ...
                a = b) : v && (B(), v.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
            return a
        }, scroll: function (a, c) {
            var b = this.pages, e = b.length;
            a = this.currentPage + a;
            var d = this.clipHeight, k = this.options.navigation, f = this.pager, g = this.padding;
            a > e && (a = e);
            0 < a && (void 0 !== c && n(c, this.chart), this.nav.attr({
                translateX: g,
                translateY: d + this.padding + 7 + this.titleHeight,
                visibility: "visible"
            }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), f.attr({text: a + "/" + e}), this.down.attr({
                x: 18 +
                this.pager.getBBox().width,
                "class": a === e ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
            }), this.up.attr({fill: 1 === a ? k.inactiveColor : k.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === e ? k.inactiveColor : k.activeColor}).css({cursor: a === e ? "default" : "pointer"}), c = -b[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = a, this.positionCheckboxes(c))
        }
        };
        a.LegendSymbolMixin = {
            drawRectangle: function (a, c) {
                ...
                c.legendSymbol = this.chart.renderer.rect(b ? (a.symbolWidth - e) / 2 : 0, a.baseline - e + 1, b ? e : a.symbolWidth, e, f(a.options.symbolRadius, e / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(c.legendGroup)
            }, drawLineMarker: function (a) {
                var c = this.options, b = c.marker, e = a.symbolWidth, d = this.chart.renderer, k = this.legendGroup;
                a = a.baseline - Math.round(.3 * a.fontMetrics.b);
                var f;
                f = {"stroke-width": c.lineWidth || 0};
                c.dashStyle && (f.dashstyle = c.dashStyle);
                this.legendLine = d.path(["M", 0, a, "L",
                    e, a]).addClass("highcharts-graph").attr(f).add(k);
    ...
    (function (a) {
        var z = a.addEvent, D = a.animate, C = a.animObject, B = a.attr, d = a.doc, h = a.Axis, q = a.createElement,
            t = a.defaultOptions, g = a.discardElement, p = a.charts, f = a.css, n = a.defined, w = a.each, v = a.extend, k = a.find, e = a.fireEvent, c = a.getStyle, b = a.grep, F = a.isNumber, u = a.isObject, r = a.isString, y = a.Legend, G = a.marginNames, I = a.merge, l = a.Pointer, x = a.pick, J = a.pInt, L = a.removeEvent, N = a.seriesTypes, m = a.splat, A = a.svg, P = a.syncTimeout, M = a.win, R = a.Renderer, E = a.Chart = function () {
        ...
        E.prototype = {
            callbacks: [], getArgs: function () {
                ...
                var c = this.axes, l = this.series, d = this.pointer, m = this.legend, k = this.isDirtyLegend, f, n, g = this.hasCartesianSeries, x = this.isDirtyBox, h = l.length, r = h, p = this.renderer, u = p.isHidden(), y =
                    [];
                a.setAnimation(b, this);
                u && this.cloneRenderTo();
                for (this.layOutTitles(); r--;)if (b = l[r], b.options.stacking && (f = !0, b.isDirty)) {
                    n = !0;
                    break
                }
                if (n)for (r = h; r--;)b = l[r], b.options.stacking && (b.isDirty = !0);
                w(l, function (a) {
                ...
                var e = this, l = e.options,
                    d;
                d = l.title = I({style: {color: "#333333", fontSize: l.isStock ? "16px" : "18px"}}, l.title, a);
                l = l.subtitle = I({style: {color: "#666666"}}, l.subtitle, b);
                w([["title", a, d], ["subtitle", b, l]], function (a, b) {
                    var c = a[0], l = e[c], d = a[1];
                    a = a[2];
                    l && d && (e[c] = l = l.destroy());
                ...
                w(["title", "subtitle"], function (a) {
                    ...
                    c && (m = d.style.fontSize, m = e.fontMetrics(m, c).b, c.css({width: (d.width || l.width + d.widthAdjust) + "px"}).align(v({y: b + m + ("title" === a ? -3 : 2)}, d), !1, "spacingBox"), d.floating || d.verticalAlign || (b = Math.ceil(b + c.getBBox().height)))
                }, this);
                ...
                var a = this.options.chart,
                    b = a.width, a = a.height, e = this.renderToClone || this.renderTo;
                ...
                var b, c = this.options, e = c.chart, l, m;
                b = this.renderTo;
                var k = a.uniqueKey(), f;
                ...
                this.container = b = q("div", {id: k}, f, this.renderToClone || b);
                ...
                var b = this, e = b.options.chart, l = b.renderTo, m = n(e.width), k = e.width || c(l, "width"), e = e.height || c(l, "height"), l = a ? a.target : M;
                ...
                var b = this.inverted, c = this.renderer, e = this.chartWidth, l = this.chartHeight, d = this.options.chart, m = this.spacing,
                    k = this.clipOffset, f, n, g, x;
                ...
                this.spacingBox = c.spacingBox = {x: m[3], y: m[0], width: e - m[3] - m[1], height: l - m[0] - m[2]};
                this.plotBox = c.plotBox = {x: f, y: n, width: g, height: x};
                ...
                var a = this.options.chart, b = this.renderer, c = this.chartWidth, e = this.chartHeight, l = this.chartBackground, d = this.plotBackground, m = this.plotBorder, k, f = this.plotBGImage, n = a.backgroundColor, g = a.plotBackgroundColor, x = a.plotBackgroundImage, h, r = this.plotLeft, p = this.plotTop, u = this.plotWidth, v = this.plotHeight, y = this.plotBox, J = this.clipRect, q = this.clipBox, w = "animate";
                ...
                l[w]({x: h / 2, y: h / 2, width: c - h - k % 2, height: e - h - k % 2, r: a.borderRadius});
                w = "animate";
                d || (w = "attr", this.plotBackground = d = b.rect().addClass("highcharts-plot-background").add());
                d[w](y);
                d.attr({fill: g || "none"}).shadow(a.plotShadow);
                x && (f ? f.animate(y) : this.plotBGImage = b.image(x, r, p, u, v).add());
                J ? J.animate({width: q.width, height: q.height}) : this.clipRect = b.clipRect(q);
                w = "animate";
                m || (w = "attr", this.plotBorder = m = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                m.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
                m[w](m.crisp({x: r, y: p, width: u, height: v}, -m.strokeWidth()));
                this.isDirtyBox = !1
            }, propFromSeries: function () {
                var a = this, b = a.options.chart, c, e = a.options.series, l, d;
                ...
                b.items && w(b.items, function (c) {
                    var e =
                        v(b.style, c.style), l = J(e.left) + a.plotLeft, d = J(e.top) + a.plotTop + 12;
                    delete e.left;
                    delete e.top;
                    a.renderer.text(c.html, l, d).attr({zIndex: 2}).css(e).add()
                })
            }, render: function () {
                var a = this.axes, b = this.renderer, c = this.options, e, l, d;
                this.setTitle();
                ...
                var b = this, c = b.axes, l = b.series, d = b.container, m, k = d && d.parentNode;
                e(b, "destroy");
                p[b.index] = void 0;
                a.chartCount--;
    ...
    (function (a) {
        var z, D = a.each, C = a.extend, B = a.erase, d = a.fireEvent, h = a.format, q = a.isArray, t = a.isNumber, g = a.pick, p = a.removeEvent;
        z = a.Point = function () {
        };
        z.prototype = {
            init: function (a, d, h) {
                ...
                var f = this.series, n = f.options.pointValKey || f.pointValKey;
                ...
                var d = {}, f = this.series, g = f.options.keys, k = g || f.pointArrayMap || ["y"], e = k.length, c = 0, b = 0;
                if (t(a) || null === a)d[k[0]] = a; else if (q(a))for (!g && a.length > e && (f = typeof a[0], "string" === f ? d.name = a[0] : "number" === f && (d.x = a[0]), c++); b < e;)g && void 0 === a[c] || (d[k[b]] = a[c]), c++, b++; else"object" === typeof a && (d = a, a.dataLabels && (f._hasPointLabels = !0), a.marker &&
                ...
                var d = this.series, f = d.tooltipOptions, p = g(f.valueDecimals, ""), k = f.valuePrefix || "", e = f.valueSuffix || "";
    ...
    (function (a) {
        var z = a.addEvent, D = a.animObject, C = a.arrayMax, B = a.arrayMin, d = a.correctFloat, h = a.Date, q = a.defaultOptions, t = a.defaultPlotOptions, g = a.defined, p = a.each, f = a.erase, n = a.extend, w = a.fireEvent,
            v = a.grep, k = a.isArray, e = a.isNumber, c = a.isString, b = a.merge, F = a.pick, u = a.removeEvent, r = a.splat, y = a.SVGElement, G = a.syncTimeout, I = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            insert: function (a) {
                ...
                if (e(b)) {
                    for (c = a.length; c--;)if (b >= F(a[c].options.index, a[c]._i)) {
                        a.splice(c + 1, 0, this);
                        break
                    }
                    -1 === c && a.unshift(this);
            ...
            updateParallelArrays: function (a, b) {
                var c = a.series, d = arguments, l = e(b) ? function (d) {
            ...
            autoIncrement: function () {
                var a = this.options, b = this.xIncrement, c, d = a.pointIntervalUnit, b = F(b, a.pointStart, 0);
            ...
            setOptions: function (a) {
                var c = this.chart, d = c.options.plotOptions, c = c.userOptions || {}, e = c.plotOptions || {}, l = d[this.type];
                this.userOptions = a;
                d = b(l, d.series, a);
                ...
                a.length && g(a[a.length - 1].value) && a.push({color: this.color, fillColor: this.fillColor});
                return d
            },
            getCyclic: function (a, b, c) {
                var d, e = this.userOptions, l = a + "Index", k = a + "Counter", f = c ? c.length : F(this.chart.options.chart[a + "Count"], this.chart[a +
                "Count"]);
            ...
            setData: function (b, d, f, g) {
                var l = this, m = l.points, n = m && m.length ||
                    0, h, r = l.options, x = l.chart, u = null, y = l.xAxis, v = r.turboThreshold, q = this.xData, t = this.yData, I = (h = l.pointArrayMap) && h.length;
                b = b || [];
                h = b.length;
                d = F(d, !0);
                if (!1 !== g && h && n === h && !l.cropped && !l.hasGroupedData && l.visible)p(b, function (a, b) {
                    ...
                    if (v && h > v) {
                        ...
                        if (e(u))for (f = 0; f < h; f++)q[f] = this.autoIncrement(), t[f] = b[f]; else if (k(u))if (I)for (f =
                                                                                                                               0; f < h; f++)u = b[f], q[f] = u[0], t[f] = u.slice(1, I + 1); else for (f = 0; f < h; f++)u = b[f], q[f] = u[0], t[f] = u[1]; else a.error(12)
                    } else for (f = 0; f < h; f++)void 0 !== b[f] && (u = {series: l}, l.pointClass.prototype.applyOptions.apply(u, [b[f]]), l.updateParallelArrays(u, f));
                    c(t[0]) && a.error(14, !0);
                    l.data = [];
            ...
            processData: function (b) {
                ...
                l = 0;
                var m, k, f = this.xAxis, g, n = this.options;
                g = n.cropThreshold;
                var h = this.getExtremesFromAll || n.getExtremesFromAll, r = this.isCartesian, n = f && f.val2lin, p = f && f.isLog, u, y;
                if (r && !this.isDirty && !f.isDirty && !this.yAxis.isDirty && !b)return !1;
                f && (b = f.getExtremes(), u = b.min, y = b.max);
                if (r && this.sorted && !h && (!g || e > g || this.forceCrop))if (c[e - 1] < u || c[0] > y)c = [], d = []; else if (c[0] < u || c[e - 1] > y)l = this.cropData(this.xData, this.yData, u, y), c = l.xData,
            ...
            cropData: function (a, b, c, d) {
                var e = a.length, l = 0, k = e, f = F(this.cropShoulder, 1), g;
                for (g = 0; g < e; g++)if (a[g] >= c) {
                    l = Math.max(0, g - f);
                    break
                }
                for (c = g; c < e; c++)if (a[c] > d) {
                    k = c + f;
                    break
                }
            ...
            generatePoints: function () {
                var a =
                    this.options.data, b = this.data, c, d = this.processedXData, e = this.processedYData, m = this.pointClass, k = d.length, f = this.cropStart || 0, g, n = this.hasGroupedData, h, p = [], u;
                ...
                if (b && (k !== (c = b.length) || n))for (u = 0; u < c; u++)u !== f || n || (u += k), b[u] && (b[u].destroyElements(), b[u].plotX = void 0);
                this.data =
                    b;
                this.points = p
            },
            getExtremes: function (a) {
                var b = this.yAxis, c = this.processedXData, d, l = [], m = 0;
                d = this.xAxis.getExtremes();
                var f = d.min, g = d.max, n, h, r, p;
                a = a || this.stackedYData || this.processedYData || [];
                d = a.length;
                for (p = 0; p < d; p++)if (h = c[p], r = a[p], n = (e(r, !0) || k(r)) && (!b.isLog || r.length || 0 < r), h = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[p + 1] || h) >= f && (c[p - 1] || h) <= g, n && h)if (n = r.length)for (; n--;)null !== r[n] && (l[m++] = r[n]); else l[m++] = r;
                this.dataMin = B(l);
                this.dataMax = C(l)
            },
            translate: function () {
                ...
                this.processData();
                this.generatePoints();
                var a = this.options, b = a.stacking, c = this.xAxis, k = c.categories, f = this.yAxis, m = this.points, n = m.length, h = !!this.modifyValue, r = a.pointPlacement, p = "between" === r || e(r), u = a.threshold, y = a.startFromThreshold ? u : 0, v, q, t, I, w = Number.MAX_VALUE;
                "between" === r && (r = .5);
                e(r) && (r *= F(a.pointRange || c.pointRange));
                for (a = 0; a < n; a++) {
                    var G = m[a], B = G.x, z = G.y;
                    q = G.low;
                    var C = b && f.stacks[(this.negStacks && z < (y ? 0 : u) ? "-" : "") + this.stackKey], D;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options,
                    d = b.renderer, e = b.inverted, l = this.clipBox, k = l || b.clipBox, f = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, k.height, c.xAxis, c.yAxis].join(), g = b[f], n = b[f + "m"];
                g || (a && (k.width = 0, b[f + "m"] = n = d.clipRect(-99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)), b[f] = g = d.clipRect(k), g.count = {length: 0});
            ...
            markerAttribs: function (a, b) {
                var c = this.options.marker, d = a && a.options, e = d && d.marker || {}, d = F(e.radius, c.radius);
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker,
                    d = a && a.options, e = d && d.marker || {}, l = this.color, k = d && d.color, f = a && a.color, d = F(e.lineWidth, c.lineWidth);
                ...
                return {stroke: l, "stroke-width": d, fill: a}
            },
            destroy: function () {
                var a = this, b = a.chart, c = /AppleWebKit\/533/.test(I.navigator.userAgent),
                    d, e = a.data || [], k, g, n;
                w(a, "destroy");
                u(a);
            ...
            getGraphPath: function (a, b, c) {
                var d = this, e = d.options, l =
                    e.step, k, f = [], n = [], h;
                a = a || d.points;
                (k = a.reversed) && a.reverse();
                (l = {right: 1, center: 2}[l] || l && 3) && k && (l = 4 - l);
                !e.connectNulls || b || c || (a = this.getValidPoints(a));
                p(a, function (k, m) {
                    var r = k.plotX, p = k.plotY, u = a[m - 1];
                    (k.leftCliff || u && u.rightCliff) && !c && (h = !0);
                    k.isNull && !g(b) && 0 < m ? h = !e.connectNulls : k.isNull && !b ? h = !0 : (0 === m || h ? m = ["M", k.plotX, k.plotY] : d.getPointSpline ? m = d.getPointSpline(a, k, m) : l ? (m = 1 === l ? ["L", u.plotX, p] : 2 === l ? ["L", (u.plotX + r) / 2, u.plotY, "L", (u.plotX + r) / 2, p] : ["L", r, u.plotY], m.push("L", r, p)) : m =
                        ["L", r, p], n.push(k.x), l && n.push(k.x), f.push.apply(f, m), h = !1)
                });
                f.xMap = n;
            ...
            drawGraph: function () {
                ...
                p(d, function (d, e) {
                    var l = d[0], k = a[l];
                    k ? (k.endX = c.xMap, k.animate({d: c})) : c.length &&
                    (a[l] = a.chart.renderer.path(c).addClass(d[1]).attr({zIndex: 1}).add(a.group), k = {
                        stroke: d[2],
            ...
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer, d = this.zones, e, k, f = this.clips || [], g, n = this.graph, h = this.area, r = Math.max(b.chartWidth, b.chartHeight), u = this[(this.zoneAxis ||
                "y") + "Axis"], y, v, q = b.inverted, t, I, w, G, B = !1;
            ...
            plotGroup: function (a, b, c, d, e) {
                var l = this[a], k = !l;
                k && (this[a] = l = this.chart.renderer.g(b).attr({zIndex: d || .1}).add(e), l.addClass("highcharts-series-" + this.index + " highcharts-" + this.type + "-series highcharts-color-" + this.colorIndex + " " + (this.options.className || "")));
                l.attr({visibility: c})[k ? "attr" : "animate"](this.getPlotBox());
                return l
            },
            getPlotBox: function () {
                ...
                return {
                    translateX: b ? b.left : a.plotLeft, translateY: c ?
                        c.top : a.plotTop, scaleX: 1, scaleY: 1
                }
            },
            render: function () {
                var a = this, b = a.chart, c, d = a.options, e = !!a.animate && b.renderer.isSVG && D(d.animation).duration, k = a.visible ? "inherit" : "hidden", f = d.zIndex, g = a.hasRendered, n = b.seriesGroup, h = b.inverted;
            ...
            redraw: function () {
                ...
                c && (a.inverted && c.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), c.animate({translateX: F(d && d.left, a.plotLeft), translateY: F(e && e.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchKDTree: function (a, b) {
                function c(a, b, f, m) {
                    var n = b.point, h = d.kdAxisArray[f % m], r, u, p = n;
                ...
                var d = this, e = this.kdAxisArray[0], k = this.kdAxisArray[1], l = b ? "distX" : "dist";
    ...
    (function (a) {
        var z = a.addEvent, D = a.animate, C = a.Axis, B = a.createElement, d = a.css, h = a.defined, q = a.each, t = a.erase, g = a.extend, p = a.fireEvent, f = a.inArray, n = a.isNumber, w = a.isObject, v = a.merge, k = a.pick, e = a.Point, c = a.Series, b = a.seriesTypes, F = a.setAnimation,
            u = a.splat;
        g(a.Chart.prototype, {
            addSeries: function (a, b, c) {
                var d, e = this;
                a && (b = k(b, !0), p(e, "addSeries", {options: a}, function () {
                    d = e.initSeries(a);
                    e.isDirtyLegend = !0;
                    e.linkSeries();
                    b && e.redraw(c)
            ...
            addAxis: function (a, b, c, d) {
                ...
                a = v(a, {index: this[e].length, isX: b});
                new C(this, a);
                f[e] = u(f[e] || {});
                f[e].push(a);
                k(c, !0) && this.redraw(d)
            ...
            showLoading: function (a) {
                var b = this, c = b.options, e = b.loadingDiv, k = c.loading, f = function () {
                    e && d(e, {
                        left: b.plotLeft + "px", top: b.plotTop +
                        "px", width: b.plotWidth + "px", height: b.plotHeight + "px"
                    })
                };
                e || (b.loadingDiv = e = B("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = B("span", {className: "highcharts-loading-inner"}, null, e), z(b, "redraw", f));
                e.className = "highcharts-loading";
                b.loadingSpan.innerHTML = a || c.lang.loading;
                d(e, g(k.style, {zIndex: 10}));
                d(b.loadingSpan, k.labelStyle);
                b.loadingShown || (d(e, {
                    opacity: 0,
                    display: ""
                }), D(e, {opacity: k.style.opacity || .5}, {duration: k.showDuration || 0}));
                b.loadingShown = !0;
                f()
            },
            ...
            update: function (a, b) {
                var c, d = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, e = a.chart, g, r;
                if (e) {
                ...
                for (c in a) {
                    if (this[c] && "function" === typeof this[c].update)this[c].update(a[c], !1); else if ("function" === typeof this[d[c]])this[d[c]](a[c]);
        ...
        g(e.prototype, {
            update: function (a, b, c, d) {
                ...
                var f = this, g = f.series, n = f.graphic, h, m = g.chart, r = g.options;
                b = k(b, !0);
        ...
        g(c.prototype, {
            addPoint: function (a,
                                b, c, d) {
                var e = this.options, f = this.data, g = this.chart, n = this.xAxis && this.xAxis.names, h = e.data, m, r, u = this.xData, p, v;
                b = k(b, !0);
                m = {series: this};
                this.pointClass.prototype.applyOptions.apply(m, [a]);
                v = m.x;
                p = u.length;
                if (this.requireSorting && v < u[p - 1])for (r = !0; p && u[p - 1] > v;)p--;
                ...
                var d = this, e = d.data, f = e[a], g = d.points, n = d.chart, h = function () {
                ...
                var d = this, e = this.chart, f = this.userOptions, n = this.type, h = a.type || f.type || e.options.chart.type, r = b[n].prototype, p = ["group", "markerGroup", "dataLabelsGroup"], m;
                if (h && h !== n || void 0 !== a.zIndex)p.length = 0;
                q(p, function (a) {
                    p[a] = d[a];
                    delete d[a]
                });
                a = v(f, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data}, a);
                this.remove(!1, null, !1);
                for (m in r)this[m] = void 0;
    ...
    (function (a) {
        var z = a.animObject, D = a.color, C = a.each, B = a.extend, d = a.isNumber, h = a.merge, q = a.pick, t = a.Series, g = a.seriesType, p = a.svg;
        g("column", "line", {
            borderRadius: 0,
            groupPadding: .2,
            marker: null,
            ...
            getColumnMetrics: function () {
                var a = this, d = a.options,
                    g = a.xAxis, h = a.yAxis, k = g.reversed, e, c = {}, b = 0;
                !1 === d.grouping ? b = 1 : C(a.chart.series, function (d) {
                    var k = d.options, f = d.yAxis, l;
                ...
                var p = Math.min(Math.abs(g.transA) * (g.ordinalSlope || d.pointRange || g.closestPointRange || g.tickInterval || 1), g.len), u = p * d.groupPadding, r = (p - 2 * u) / b, d = Math.min(d.maxPointWidth || g.len, q(d.pointWidth, r * (1 - 2 * d.pointPadding)));
                a.columnMetrics =
                {width: d, offset: (r - d) / 2 + (u + ((a.columnIndex || 0) + (k ? 1 : 0)) * r - p / 2) * (k ? -1 : 1)};
                return a.columnMetrics
            },
            crispCol: function (a, d, g, h) {
                var k = this.chart, e = this.borderWidth, c = -(e % 2 ? .5 : 0), e = e % 2 ? .5 : 1;
            ...
            translate: function () {
                var a = this, d = a.chart, g = a.options, h = a.dense = 2 > a.closestPointRange * a.xAxis.transA, h = a.borderWidth = q(g.borderWidth,
                    h ? 0 : 1), k = a.yAxis, e = a.translatedThreshold = k.getThreshold(g.threshold), c = q(g.minPointLength, 5), b = a.getColumnMetrics(), p = b.width, u = a.barW = Math.max(p, 1 + 2 * h), r = a.pointXOffset = b.offset;
                d.inverted && (e -= .5);
                g.pointPadding && (u = Math.ceil(u));
                t.prototype.translate.apply(a);
                C(a.points, function (b) {
                    var f = q(b.yBottom, e), g = 999 + Math.abs(f), g = Math.min(Math.max(-g, b.plotY), k.len + g), l = b.plotX + r, h = u, n = Math.min(g, f), v, y = Math.max(g, f) - n;
            ...
            pointAttribs: function (a, d) {
                var f = this.options, g, k = this.pointAttrToOptions || {};
                g = k.stroke || "borderColor";
                var e = k["stroke-width"] || "borderWidth", c = a && a.color || this.color, b = a[g] || f[g] || this.color || c, h = a[e] || f[e] || this[e] || 0, k = f.dashStyle;
                ...
                g = {fill: c, stroke: b, "stroke-width": h};
                f.borderRadius && (g.r = f.borderRadius);
                k && (g.dashstyle = k);
                return g
            },
            drawPoints: function () {
                var a = this, g = this.chart, p = a.options,
                    v = g.renderer, k = p.animationLimit || 250, e;
                C(a.points, function (c) {
                    var b = c.graphic;
                    if (d(c.plotY) && null !== c.y) {
                        e = c.shapeArgs;
                        if (b)b[g.pointCount < k ? "animate" : "attr"](h(e)); else c.graphic = b = v[c.shapeType](e).attr({"class": c.getClassName()}).add(c.group || a.group);
                        b.attr(a.pointAttribs(c, c.selected && "select")).shadow(p.shadow, null, p.stacking && !p.borderRadius)
                    } else b && (c.graphic = b.destroy())
                })
            },
            animate: function (a) {
                var d = this, f = this.yAxis, g = d.options, k = this.chart.inverted, e = {};
    ...
    (function (a) {
        var z = a.addEvent, D = a.arrayMax, C = a.defined, B = a.each, d = a.extend, h = a.format, q = a.map, t = a.merge, g = a.noop, p = a.pick, f = a.relativeLength, n = a.Series, w = a.seriesTypes, v = a.stableSort;
        ...
        n.prototype.drawDataLabels = function () {
            var a =
                this, e = a.options, c = e.dataLabels, b = a.points, f, g, n = a.hasRendered || 0, q, v, w = p(c.defer, !0), l = a.chart.renderer;
            if (c.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(c), v = a.plotGroup("dataLabelsGroup", "data-labels", w && !n ? "hidden" : "visible", c.zIndex || 6), w && (v.attr({opacity: +n}), n || z(a, "afterAnimate", function () {
                a.visible && v.show(!0);
                v[e.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), g = c, B(b, function (b) {
                var k, n = b.dataLabel, r, m, u = b.connector, y = !0, x, w = {};
                f = b.dlOptions || b.options &&
                    b.options.dataLabels;
                k = p(f && f.enabled, g.enabled) && null !== b.y;
                if (n && !k)b.dataLabel = n.destroy(); else if (k) {
                    c = t(g, f);
                    x = c.style;
                    k = c.rotation;
                    r = b.getLabelConfig();
                    ...
                    if (n)C(q) ? (n.attr({text: q}), y = !1) : (b.dataLabel = n = n.destroy(), u && (b.connector = u.destroy())); else if (C(q)) {
                        n = {
        ...
        n.prototype.alignDataLabel = function (a, e, c, b,
                                               f) {
            var k = this.chart, g = k.inverted, h = p(a.plotX, -9999), n = p(a.plotY, -9999), q = e.getBBox(), l, v = c.rotation, t = c.align, w = this.visible && (a.series.forceDL || k.isInsidePlot(h, Math.round(n), g) || b && k.isInsidePlot(h, g ? b.x + 1 : b.y + b.height - 1, g)), F = "justify" === p(c.overflow, "justify");
            w && (l = c.style.fontSize, l = k.renderer.fontMetrics(l, e).b, b = d({
                x: g ? k.plotWidth - n : h,
                y: Math.round(g ? k.plotHeight - h : n),
                width: 0,
                height: 0
            }, b), d(c, {width: q.width, height: q.height}), v ? (F = !1, g = k.renderer.rotCorr(l, v), g = {
                x: b.x + c.x + b.width / 2 + g.x, y: b.y +
                c.y + {top: 0, middle: .5, bottom: 1}[c.verticalAlign] * b.height
            }, e[f ? "attr" : "animate"](g).attr({align: t}), h = (v + 720) % 360, h = 180 < h && 360 > h, "left" === t ? g.y -= h ? q.height : 0 : "center" === t ? (g.x -= q.width / 2, g.y -= q.height / 2) : "right" === t && (g.x -= q.width, g.y -= h ? 0 : q.height)) : (e.align(c, null, b), g = e.alignAttr), F ? this.justifyDataLabel(e, c, g, q, b, f) : p(c.crop, !0) && (w = k.isInsidePlot(g.x, g.y) && k.isInsidePlot(g.x + q.width, g.y + q.height)), c.shape && !v && e.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
        ...
        n.prototype.justifyDataLabel =
            function (a, d, c, b, f, g) {
                var e = this.chart, k = d.align, h = d.verticalAlign, n, l, p = a.box ? 0 : a.padding || 0;
                n = c.x + p;
        ...
        w.pie && (w.pie.prototype.drawDataLabels = function () {
            var d = this, e = d.data, c, b = d.chart,
                f = d.options.dataLabels, g = p(f.connectorPadding, 10), h = p(f.connectorWidth, 1), v = b.plotWidth, t = b.plotHeight, w, l = f.distance, x = d.center, z = x[2] / 2, C = x[1], N = 0 < l, m, A, P, M, R = [[], []], E, H, K, Q, O = [0, 0, 0, 0];
            d.visible && (f.enabled || d._hasPointLabels) && (n.prototype.drawDataLabels.apply(d), B(e, function (a) {
                ...
                var h, n, p = e.length, u, r, y;
                if (p)for (d.sortByAngle(e, k - .5), 0 < l && (h = Math.max(0, C - z - l), n = Math.min(C + z + l, b.plotHeight), u = q(e, function (a) {
                    if (a.dataLabel)return y =
                        a.dataLabel.getBBox().height || 21, {target: a.labelPos[1] - h + y / 2, size: y, rank: a.y}
                ...
                if ((m = a.dataLabel) && m._pos && a.visible) {
                    ...
                    if (c = !w)a.connector = w = b.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(d.dataLabelsGroup), w.attr({
                        "stroke-width": h, stroke: f.connectorColor ||
                        a.color || "#666666"
                    });
            ...
            B(this.points, function (a) {
                ...
                d && a.visible && ((a = d._pos) ?
                    (d.attr(d._attr), d[d.moved ? "animate" : "attr"](a), d.moved = !0) : d && d.attr({y: -9999}))
            })
        }, w.pie.prototype.alignDataLabel = g, w.pie.prototype.verifyDataLabelOverflow = function (a) {
            var d = this.center, c = this.options, b = c.center, g = c.minSize || 80, k, h;
        ...
        w.column && (w.column.prototype.alignDataLabel = function (a, d, c, b, f) {
            var e = this.chart.inverted, g = a.series, k = a.dlBox || a.shapeArgs, h = p(a.below, a.plotY > p(this.translatedThreshold, g.yAxis.len)), q = p(c.inside, !!this.options.stacking);
    ...
    (function (a) {
        var z = a.Chart, D = a.each, C = a.pick, B = a.addEvent;
        ...
        z.prototype.hideOverlappingLabels = function (a) {
            var d = a.length, q, t, g, p, f, n, w, v, k, e = function (a, b, d, e, f, g, k, h) {
                return !(f > a + d || f + k < a || g > b + e || g + h < b)
            };
            for (t = 0; t < d; t++)if (q = a[t])q.oldOpacity = q.opacity, q.newOpacity = 1;
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (t = 0; t < d; t++)for (g = a[t], q = t + 1; q < d; ++q)if (p = a[q], g && p && g.placed && p.placed && 0 !==
    ...
    (function (a) {
        ...
        a(z.prototype, "setAxisTranslation", function (a) {
            var d = this.chart, h = d.plotWidth /
                d.plotHeight, d = d.xAxis[0], q;
            a.call(this);
    ...
    (function (a) {
        var z = a.Axis, D = a.Chart, C = a.color, B, d = a.each, h = a.extend, q = a.isNumber, t = a.Legend, g = a.LegendSymbolMixin, p = a.noop, f = a.merge, n = a.pick, w = a.wrap;
        ...
        h(B.prototype, {
            ...
            init: function (a, d) {
                var e = "vertical" !== a.options.legend.layout, c;
                this.coll = "colorAxis";
                c = f(this.defaultColorAxisOptions, {side: e ? 2 : 1, reversed: !e}, d, {
                    opposite: !e,
                    showEmpty: !1,
                    title: null
                });
            ...
            initDataClasses: function (a) {
                var g = this, e = this.chart, c, b = 0, h = e.options.chart.colorCount, n = this.options, p = a.dataClasses.length;
                this.dataClasses = c = [];
                this.legendItems = [];
            ...
            setAxisSize: function () {
                var a = this.legendSymbol, d = this.chart, e = d.options.legend ||
                    {}, c, b;
            ...
            toColor: function (a, d) {
                var e = this.stops, c, b, f = this.dataClasses, g, k;
            ...
            setLegendColor: function () {
                var a,
                    d = this.options, e = this.reversed;
                a = e ? 1 : 0;
                e = e ? 0 : 1;
            ...
            drawLegendSymbol: function (a, d) {
                var e = a.padding, c = a.options, b = this.horiz, f = n(c.symbolWidth, b ? this.defaultLegendLength : 12), g = n(c.symbolHeight, b ? 12 : this.defaultLegendLength), k = n(c.labelPadding, b ? 16 : 30), c = n(c.itemDistance, 10);
                this.setLegendColor();
                d.legendSymbol = this.chart.renderer.rect(0, a.baseline - 11, f, g).attr({zIndex: 1}).add(d.legendGroup);
            ...
            drawCrosshair: function (a, d) {
                var e = d && d.plotX, c = d && d.plotY, b, f = this.pos, g = this.len;
            ...
            getDataClassLegendSymbols: function () {
                var f = this, k = this.chart, e = this.legendItems, c = k.options.legend, b = c.valueDecimals, n = c.valueSuffix || "", u;
                e.length || d(this.dataClasses, function (c, q) {
                    var r = !0, v = c.from, l = c.to;
                    u = "";
        ...
        w(t.prototype, "getAllItems", function (a) {
            var f = [], e = this.chart.colorAxis[0];
    ...
    (function (a) {
        var z = a.defined, D = a.each, C = a.noop, B = a.seriesTypes;
        a.colorPointMixin =
        {
            isValid: function () {
                return null !== this.value
            }, setVisible: function (a) {
            var d = this, q = a ? "show" : "hide";
        ...
        a.colorSeriesMixin = {
            ...
            translateColors: function () {
                var a = this, h = this.options.nullColor, q = this.colorAxis, t = this.colorKey;
    ...
    (function (a) {
        var z = a.color, D = a.ColorAxis, C = a.colorPointMixin, B = a.each, d = a.extend, h = a.isNumber, q = a.map, t = a.merge, g = a.noop, p = a.pick, f = a.isArray,
            n = a.Point, w = a.Series, v = a.seriesType, k = a.seriesTypes, e = a.splat, c = void 0 !== a.doc.documentElement.style.vectorEffect;
        v("map", "scatter", {
            allAreas: !0,
            animation: !1,
            nullColor: "#f7f7f7",
            ...
            states: {
                normal: {animation: !0},
                hover: {brightness: .2, halo: null}, select: {color: "#cccccc"}
            }
            ...
            pointArrayMap: ["value"],
            getBox: function (b) {
                var c = Number.MAX_VALUE, d = -c, e = c, f = -c, g = c, k = c, l = this.xAxis, n = this.yAxis, q;
                B(b || [], function (b) {
                    if (b.path) {
                        "string" === typeof b.path && (b.path = a.splitPath(b.path));
                        var l = b.path || [], m = l.length, n = !1, u = -c, r = c, t = -c, v = c, y = b.properties;
                        if (!b._foundBox) {
                            for (; m--;)h(l[m]) &&
                ...
                q && (this.minY = Math.min(g, p(this.minY, c)), this.maxY = Math.max(f, p(this.maxY,
                    -c)), this.minX = Math.min(e, p(this.minX, c)), this.maxX = Math.max(d, p(this.maxX, -c)), l && void 0 === l.options.minRange && (l.minRange = Math.min(5 * k, (this.maxX - this.minX) / 5, l.minRange || c)), n && void 0 === n.options.minRange && (n.minRange = Math.min(5 * k, (this.maxY - this.minY) / 5, n.minRange || c)))
            },
            getExtremes: function () {
            ...
            translatePath: function (a) {
                var b = !1, c = this.xAxis, d = this.yAxis, e = c.min, f = c.transA, c = c.minPixelPadding, g = d.min, l = d.transA, d = d.minPixelPadding, k, n = [];
                if (a)for (k = a.length; k--;)h(a[k]) ? (n[k] = b ? (a[k] - e) * f + c : (a[k] - g) * l + d, b = !b) : n[k] = a[k];
                return n
            },
            setData: function (b, c, d, g) {
                var k = this.options, n = this.chart.options.chart, p = n && n.map, l = k.mapData, u = k.joinBy, r = null === u, v = k.keys || this.pointArrayMap, z = [], m = {}, A, F = this.chart.mapTransforms;
                ...
                b && B(b, function (a, c) {
                    var d = 0;
                    if (h(a))b[c] = {value: a}; else if (f(a)) {
                        b[c] = {};
                ...
                this.getBox(b);
                if (this.chart.mapTransforms = F = n && n.mapTransforms || l && l["hc-transform"] || F)for (A in F)F.hasOwnProperty(A) && A.rotation && (A.cosAngle = Math.cos(A.rotation), A.sinAngle = Math.sin(A.rotation));
                if (l) {
                    ...
                    k.allAreas ? (this.getBox(l), b = b || [], u[1] && B(b, function (a) {
                        ...
                        u[0] && -1 !== z.indexOf("|" + a[u[0]] + "|") || (b.push(t(a, {value: null})), g = !1)
                    })) : this.getBox(z)
                }
            ...
            translate: function () {
                ...
                B(a.data, function (b) {
                    ...
                    e && (b.shapeType = "path", b.shapeArgs = {d: a.translatePath(b.path)})
                });
                a.translateColors()
            },
            pointAttribs: function (a, d) {
            ...
            drawPoints: function () {
                var a = this, d = a.xAxis, e = a.yAxis, f = a.group, g = a.chart, n = g.renderer, h, l, p, q, v = this.baseTrans, t, m, w, z, C;
                ...
                a.doFullTranslate() ? (g.hasRendered && B(a.points, function (b) {
                    ...
                    l = e.transA / v.transAY, p = d.toPixels(v.originX, !0), q = e.toPixels(v.originY, !0), .99 < h && 1.01 > h && .99 < l && 1.01 > l && (l = h = 1, p = Math.round(p), q = Math.round(q)), t = this.transformGroup, g.renderer.globalAnimation ? (m = t.attr("translateX"), w = t.attr("translateY"), z = t.attr("scaleX"), C = t.attr("scaleY"), t.attr({animator: 0}).animate({animator: 1}, {
                    step: function (a, b) {
                        t.attr({
                ...
                })) : t.attr({translateX: p, translateY: q, scaleX: h, scaleY: l}));
            ...
            render: function () {
                var a = this, c = w.prototype.render;
                a.chart.renderer.isVML && 3E3 < a.data.length ? setTimeout(function () {
                    c.call(a)
                }) : c.call(a)
            },
            animate: function (a) {
                var b = this.options.animation, c = this.group,
                    d = this.xAxis, e = this.yAxis, f = d.pos, g = e.pos;
            ...
            applyOptions: function (a, c) {
                ...
                if (null !== this.value)n.prototype.onMouseOver.call(this, a); else this.series.onMouseOut(a)
            }, onMouseOut: function () {
                var a = this, c = +new Date, d = z(this.series.pointAttribs(a).fill), e = z(this.series.pointAttribs(a, "hover").fill), f = a.series.options.states.normal.animation, g = f && (f.duration || 500);
                g && 4 === d.rgba.length && 4 === e.rgba.length &&
                "select" !== a.state && (clearTimeout(a.colorInterval), a.colorInterval = setInterval(function () {
                    var b = (new Date - c) / g, f = a.graphic;
                    1 < b && (b = 1);
    ...
    (function (a) {
        ...
        var D = a.addEvent, C = a.Chart, B = a.doc, d = a.each, h = a.extend, q = a.merge, t = a.pick;
        a = a.wrap;
        h(C.prototype, {
            renderMapNavigation: function () {
                var a = this, d = this.options.mapNavigation, f = d.buttons, n, w, v, k, e, c = function (b) {
                    this.handler.call(a, b);
                    z(b)
                };
                if (t(d.enableButtons, d.enabled) && !a.renderer.forExport)for (n in a.mapNavButtons = [], f)f.hasOwnProperty(n) && (v = q(d.buttonOptions, f[n]), w = v.theme, w.style = q(v.theme.style, v.style), e = (k = w.states) && k.hover, k = k && k.select,
                ...
                var g = this.xAxis[0], k = g.max - g.min, e = t(d, g.min + k / 2), c = k * a, k = this.yAxis[0], b = k.max - k.min, n = t(f, k.min + b / 2), b = b * a, e = this.fitToBox({
        ...
        a(C.prototype, "render", function (a) {
            var d = this, f = d.options.mapNavigation;
    ...
    (function (a) {
        var z = a.extend, D = a.pick, C = a.Pointer;
        a = a.wrap;
        z(C.prototype, {
    ...
    (function (a) {
        var z = a.seriesType, D = a.seriesTypes;
    ...
    (function (a) {
        var z =
            a.arrayMax, D = a.arrayMin, C = a.Axis, B = a.color, d = a.each, h = a.isNumber, q = a.noop, t = a.pick, g = a.pInt, p = a.Point, f = a.Series, n = a.seriesType, w = a.seriesTypes;
        n("bubble", "scatter", {
                dataLabels: {
                    formatter: function () {
                        return this.point.z
            ...
            },
            {
                ...
                getRadii: function (a, d, e, c) {
                    var b, f, g, k = this.zData, h = [], n = this.options, p = "width" !== n.sizeBy, l = n.zThreshold, q = d - a;
                    f = 0;
                ...
                animate: function (a) {
                    ...
                    a || (d(this.points, function (a) {
                        var c = a.graphic;
                        a = a.shapeArgs;
                        c && a && (c.attr("r", 1), c.animate({r: a.r}, f))
                    }), this.animate = null)
                },
                translate: function () {
                ...
                drawLegendSymbol: function (a, d) {
                    var e = this.chart.renderer, c = e.fontMetrics(a.itemStyle && a.itemStyle.fontSize, d.legendItem).f / 2;
                    d.legendSymbol = e.circle(c, a.baseline - c, c).attr({zIndex: 3}).add(d.legendGroup);
        ...
        C.prototype.beforePadding = function () {
            var a = this, f = this.len, e = this.chart, c = 0, b = f, n = this.isXAxis, p = n ? "xData" : "yData", q = this.min, w = {}, G = Math.min(e.plotWidth, e.plotHeight), I = Number.MAX_VALUE, l = -Number.MAX_VALUE, x = this.max - q, B = f / x, C = [];
            ...
            d(C, function (d) {
                var e = d[p], f = e.length, g;
                n && d.getRadii(I, l, d.minPxSize, d.maxPxSize);
                if (0 < x)for (; f--;)h(e[f]) && a.dataMin <= e[f] && e[f] <= a.dataMax && (g = d.radii[f], c = Math.min((e[f] - q) * B - g, c), b = Math.max((e[f] - q) * B + g, b))
            });
            C.length && 0 <
            x && !this.isLog && (b -= f, B *= (f + c - b) / f, d([["min", "userMin", c], ["max", "userMax", b]], function (b) {
                void 0 === t(a.options[b[0]], a[b[1]]) && (a[b[0]] += b[2] / B)
            }))
        }
    })(K);
    (function (a) {
        var z = a.merge, D = a.Point, C = a.seriesType, B = a.seriesTypes;
    ...
    (function (a) {
        function z(a, d) {
            var f, g, h, p = !1, k = a.x, e = a.y;
            a = 0;
            for (f = d.length - 1; a < d.length; f = a++)g = d[a][1] > e, h = d[f][1] > e, g !== h && k < (d[f][0] - d[a][0]) * (e - d[a][1]) / (d[f][1] - d[a][1]) + d[a][0] && (p = !p);
            return p
        }

        var D = a.Chart, C = a.each, B = a.extend, d = a.format, h = a.merge, q = a.win, t = a.wrap;
        D.prototype.transformFromLatLon =
            function (d, h) {
                if (void 0 === q.proj4)return a.error(21), {x: 0, y: null};
                d = q.proj4(h.crs, [d.lon, d.lat]);
                var f = h.cosAngle || h.rotation && Math.cos(h.rotation), g = h.sinAngle || h.rotation && Math.sin(h.rotation);
        ...
        D.prototype.transformToLatLon = function (d, h) {
            if (void 0 === q.proj4)a.error(21); else {
                d =
                {
                ...
                var f = h.cosAngle || h.rotation && Math.cos(h.rotation), g = h.sinAngle || h.rotation && Math.sin(h.rotation);
                h = q.proj4(h.crs, "WGS84", h.rotation ? {x: d.x * f + d.y * -g, y: d.x * g + d.y * f} : d);
                return {lat: h.y, lon: h.x}
            }
        };
        D.prototype.fromPointToLatLon = function (d) {
            var g = this.mapTransforms, f;
            if (g) {
                for (f in g)if (g.hasOwnProperty(f) && g[f].hitZone && z({x: d.x, y: -d.y},
        ...
        D.prototype.fromLatLonToPoint = function (d) {
            var g = this.mapTransforms, f, h;
            if (!g)return a.error(22), {x: 0, y: null};
            for (f in g)if (g.hasOwnProperty(f) && g[f].hitZone && (h = this.transformFromLatLon(d, g[f]), z({
                    x: h.x,
                    y: -h.y
        ...
        a.geojson = function (a, h, f) {
            ...
            C(a.features, function (a) {
                ...
                "map" === h || "mapbubble" === h ? ("Polygon" === c ? (C(d, q), p.push("Z")) : "MultiPolygon" === c && (C(d, function (a) {
                    C(a, q)
                }), p.push("Z")), p.length && (b = {path: p})) : "mapline" === h ? ("LineString" === c ? q(d) : "MultiLineString" === c && C(d, q), p.length && (b = {path: p})) : "mappoint" === h && "Point" === c && (b = {
                    x: d[0],
                    y: -d[1]
                });
                b && g.push(B(b, {name: a.name || a.NAME, properties: a}))
            });
            f && a.copyrightShort && (f.chart.mapCredits = d(f.chart.options.credits.mapText, {geojson: a}), f.chart.mapCreditsFull = d(f.chart.options.credits.mapTextFull, {geojson: a}));
            return g
        };
    ...
    (function (a) {
        ...
        var D = a.Chart, C = a.defaultOptions, B = a.each, d = a.extend, h = a.merge, q = a.pick, t = a.Renderer, g = a.SVGRenderer, p = a.VMLRenderer;
        ...
        a.Map = a.mapChart = function (d, g, p) {
            var f = "string" === typeof d || d.nodeName, k = arguments[f ? 1 : 0], e = {
                endOnTick: !1,
                visible: !1,
                minPadding: 0,
                maxPadding: 0,
            ...
            k = h({
                ...
                xAxis: e,
                yAxis: h(e, {reversed: !0})
            }, k, {chart: {inverted: !1, alignTicks: !1}});
            k.series = c;
            return f ? new D(d, k, p) : new D(k, g)
        }
    })(K);
    (function (a) {
        var z = a.colorPointMixin, D = a.each, C = a.merge, B = a.noop, d = a.pick, h = a.Series, q = a.seriesType, t = a.seriesTypes;
        q("heatmap", "scatter", {
            ...
            translate: function () {
                var a = this.options, d = this.xAxis, f = this.yAxis, h = function (a, d, f) {
                    return Math.min(Math.max(d, a), f)
                };
                this.generatePoints();
                D(this.points, function (g) {
                    var n = (a.colsize || 1) / 2, k = (a.rowsize || 1) / 2, e = h(Math.round(d.len - d.translate(g.x - n, 0, 1, 0, 1)), -d.len, 2 * d.len), n = h(Math.round(d.len - d.translate(g.x + n, 0, 1, 0, 1)), -d.len, 2 * d.len), c = h(Math.round(f.translate(g.y - k, 0, 1, 0, 1)), -f.len, 2 * f.len), k = h(Math.round(f.translate(g.y + k, 0, 1, 0, 1)), -f.len, 2 * f.len);
    ...
    (function (a) {
        var z = a.addEvent, D = a.Chart, C = a.createElement, B = a.css, d = a.defaultOptions, h = a.defaultPlotOptions, q = a.each, t = a.extend, g = a.fireEvent,
            p = a.hasTouch, f = a.inArray, n = a.isObject, w = a.Legend, v = a.merge, k = a.pick, e = a.Point, c = a.Series, b = a.seriesTypes, F = a.svg;
        a = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                a._hasTracking || (q(a.trackerGroups, function (b) {
                    if (a[b]) {
                        ...
                        a.options.cursor && a[b].css(B).css({cursor: a.options.cursor})
                    }
                }), a._hasTracking = !0)
            }, drawTrackerGraph: function () {
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, g = a.chart, f = g.pointer, h = g.renderer, k = g.options.tooltip.snap, n = a.tracker, m, t = function () {
                ...
                n ? n.attr({d: d}) : a.graph && (a.tracker = h.path(d).attr({
                    "stroke-linejoin": "round",
        ...
        t(D.prototype, {
            showResetZoom: function () {
                ...
                q("xy" === b ? [1, 0] : [1], function (b) {
                    b = c[b ? "xAxis" : "yAxis"][0];
                    var d = b.horiz, g = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", f = c[d], h = (b.pointRange || 0) / 2, l = b.getExtremes(), k = b.toValue(f - g, !0) + h, h = b.toValue(f + b.len - g, !0) - h, n = h < k, f = n ? h : k, k = n ? k : h, h = Math.min(l.dataMin, l.min) - f, l = k - Math.max(l.dataMax, l.max);
                    b.series.length && 0 > h && 0 > l && (b.setExtremes(f, k, !1, !1, {trigger: "pan"}), e = !0);
                    c[d] = g
                });
                e && c.redraw(!1);
        ...
        t(e.prototype, {
            select: function (a, b) {
                ...
                var c = Math.floor(this.plotX),
                    d = this.plotY, e = this.series, f = e.options.states[a] || {}, g = h[e.type].marker && e.options.marker, n = g && !1 === g.enabled, q = g && g.states && g.states[a] || {}, p = !1 === q.enabled, m = e.stateMarkerGraphic, r = this.marker || {}, u = e.chart, w = e.halo, v, z = g && e.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === f.enabled || a && (p || n && !1 === q.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
                    ...
                    if (this.graphic)this.state && this.graphic.removeClass("highcharts-point-" +
                        this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(e.pointAttribs(this, a)), v && this.graphic.animate(v, k(u.options.chart.animation, q.animation, g.animation)), m && m.hide(); else {
                        if (a && q) {
                            g = r.symbol || e.symbol;
                    ...
                    (c = f.halo) && c.size ? (w || (e.halo = w = u.renderer.path().add(z ? e.markerGroup : e.group)), w[b ? "animate" : "attr"]({d: this.haloPath(c.size)}), w.attr({"class": "highcharts-halo highcharts-color-" + k(this.colorIndex, e.colorIndex)}), w.point = this, w.attr(t({
        ...
        t(c.prototype, {
            onMouseOver: function () {
                ...
                var b = this, c =
                    b.options, d = b.graph, e = c.states, g = c.lineWidth, c = 0;
                a = a || "";
                if (b.state !== a && (q([b.group, b.markerGroup], function (c) {
                        c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a))
                    }), b.state = a, !e[a] || !1 !== e[a].enabled) && (a && (g = e[a].lineWidth || g + (e[a].lineWidthPlus || 0)), d && !d.dashstyle))for (e = {"stroke-width": g}, d.attr(e); b["zone-graph-" + c];)b["zone-graph-" + c].attr(e), c += 1
    ...
    (function (a) {
        var z = a.Chart, D = a.each, C = a.inArray, B = a.isObject, d = a.pick, h = a.splat;
        ...
        z.prototype.matchResponsiveRule = function (h, t) {
            var g = this.respRules, p = h.condition,
                f;
        ...
        z.prototype.currentOptions = function (a) {
            function d(a, g, n) {
                var f, p;
                for (f in a)if (-1 <
                    C(f, ["series", "xAxis", "yAxis"]))for (a[f] = h(a[f]), n[f] = [], p = 0; p < a[f].length; p++)n[f][p] = {}, d(a[f][p], g[f][p], n[f][p]); else B(a[f]) ? (n[f] = {}, d(a[f], g[f] || {}, n[f])) : n[f] = g[f] || null
            }
